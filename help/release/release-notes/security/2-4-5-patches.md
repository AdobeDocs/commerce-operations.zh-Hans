...
>
>在此日期之后，Adobe Commerce 2.4.5将不再为MySQL 8.0之后发布的任何MySQL版本提供兼容性或>支持。Adobe在此Adobe>Commerce发行行中不会>验证或支持较新的MySQL主要版本。
>
>强烈建议所有运行版本2.4.5的Adobe Commerce本地客户将其数据库服务器迁移到兼容的MariaDB版本。>
