---
title: Adobe Commerce 2.4.4-p8发行说明
description: 了解2.4.4-p8 Adobe Commerce版本中安全问题的修复。
...
# Adobe Commerce 2.4.4-p8发行说明

Adobe Commerce 2.4.4-p8是一个安全版本，提供了三个安全修复，用于增强Adobe Commerce 2.4.4或Magento Open Source2.4.4部署。 它修复了以前版本中发现的漏洞。
