...
Magento Open Source2.4.1引入了性能和安全性增强功能。 安全增强功能包括支持Cookie的`SameSite`属性，为与支付和订单相关的API端点以及下单店面页面添加了CAPTCHA保护。

此版本包括2.4.0中包含的所有核心质量改进、核心代码的150多个新修复以及超过15项安全增强。 其中包括我们的社区成员解决近300个GitHub问题。 这些社区贡献的内容从小幅度的核心代码清理到GraphQL中的显着改进。

此版本中修复了2.4.0中标识的所有已知问题。
...
* **增强的安全扫描工具**。 Adobe已与[Sanguine Security](https://sansec.io/)（防止数字盗版的领先者）合作，将其超过8700个威胁签名的数据库集成到安全扫描工具中。 这种合作关系将使商家能够通过主动检测恶意软件并减少误报，实时了解其网站的安全状态。 商家可以通过访问https://account.magento.com/scanner注册该工具。 有关详细信息，请参阅[使用增强的安全扫描工具保护您的店面](https://magento.com/blog/magento-news/secure-your-storefront-enhanced-magento-security-scan-tool)博客文章。
...
* **增强的消息队列使用者性能**。 三个新的配置设置支持减少使用者队列CPU消耗。 这些可选参数可增强对使用者的控制并节省服务器资源。 有关`maxIdleTime`、`sleep`和`onlySpawnWhenMessageAvailable`参数的说明，请参阅[配置消息队列](https://developer.adobe.com/commerce/php/development/components/message-queues/configuration/)。

* **已改进`bin/magento`命令的执行时间**。
...
* **礼品选项**。 所有客户和客人均可在订单中添加礼品信息。 客户还可以在订单中添加礼品包装、礼品收据和打印卡。 查看[`setGiftOptionsOnCart`突变](https://developer.adobe.com/commerce/webapi/graphql/mutations/set-gift-options.html)和[`updateCartItems`突变](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-cart-items.html)<!-- MC-32345-->

* **订单历史记录**。 所有客户都可以查看有关其订单历史记录的详细信息，包括发票、装运和退款。<!-- MC-20635-->

* **添加到购物车**。 [`addProductsToCart`变异](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-cart.html)允许您将任何类型的产品添加到活动购物车。 我们建议使用此突变，而不是单一目的突变，例如`addSimpleProductsToCart`。 _由Yaroslav Rogoza在拉取请求[中提交的修复27914](https://github.com/magento/magento2/pull/27914)_。 [GitHub-28524](https://github.com/magento/magento2/issues/28524) <!-- MC-21513-->
...
* **卡拉纳·GraphQL**。 在[Klarna的付款方式](https://developer.adobe.com/commerce/webapi/graphql/payment-methods/klarna.html)和[`createKlarnaPaymentsSession`](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-klarna-payments-session.html)中添加或更新了Klarna GraphQL主题
...
* 运行`bin/magento config:show <vendor_module>/general/value`现在会按预期返回`0`或空字符串。 以前，它返回`Configuration for path: "vendor_module/general/value" doesn't exist`。 _由Vadim Malesh在拉取请求[中提交的修复28549](https://github.com/magento/magento2/pull/28549)_。 [GitHub-23290](https://github.com/magento/magento2/issues/23290)

<!-- ENGCOM-7853-->

* `bin/magento setup:static-content:deploy --language=all`现在在未设置语言参数时，将部署店面中使用的所有语言以及管理员用户配置的所有语言。 （`en_US`始终默认部署。） _Anton Evers在拉取请求[中提交的修复28922](https://github.com/magento/magento2/pull/28922)_。 [GitHub-29218](https://github.com/magento/magento2/issues/29218)
...
* Adobe Stock图库图像详细信息页面的&#x200B;**用于**&#x200B;字段现在可准确识别图像是否与产品相关联。 _Nazar Klovanych在拉取请求[中提交的修复28798](https://github.com/magento/magento2/pull/28798)_。 [GitHub-1474](https://github.com/magento/adobe-stock-integration/issues/1474)
...
* 现在，单击图像详细信息页面的“ **用于”** 部分中的链接会显示一个网格，其中显示了按图像筛选的所有实体。 资源筛选器也会正确设置和显示。 以前，应用程序不会在“ **应用的筛选器** ”部分中显示资源标题。 _修复由纳扎尔·克洛瓦尼奇在拉取请求 [29367](https://github.com/magento/magento2/pull/29367)_ 中提交。 [GitHub-1694](https://github.com/magento/adobe-stock-integration/issues/1694)

<!-- ENGCOM-7976 -->

* 不使用图像时，应用程序不再显示 **图像详细信息页面的“使用位置**”部分。 _修复由纳扎尔·克洛瓦尼奇在拉取请求 [29367](https://github.com/magento/magento2/pull/29367)_ 中提交。 [GitHub-1699](https://github.com/magento/adobe-stock-integration/issues/1699)
...
* Amazon Pay现在可在电子邮件和其他显示的位置中正确填充`store name`。  如果Amazon支付配置中的&#x200B;**商店名称**&#x200B;字段为空，则扩展会检索该商店的默认名称（即，您在Admin中为其指定的名称）。

* “拒绝”情景的本地化/翻译问题已得到解决。 显示的文本不再总是使用英语。

### 捆绑产品

<!-- MC-36281-->

* 当您尝试在安装了清单但禁用了`Magento_InventoryBundleProduct`模块的部署中创建产品时，应用程序不再引发异常。
...
* 按计划重新索引大型目录时，清漆不再引发`Connection reset by peer`错误。 由Matthew O&#39;Loughlin在拉取请求[中提交的&#x200B;_修复26256](https://github.com/magento/magento2/pull/26256)_。 [GitHub-8815](https://github.com/magento/magento2/issues/8815)
...
* `localStorage`聚合填充已从`base`移动到`frontend`。 _由Ihor Sviziev在拉取请求[中提交的修复28749](https://github.com/magento/magento2/pull/28749)_。 [GitHub-28900](https://github.com/magento/magento2/issues/28900)

<!-- ENGCOM-7753-->

* 更新了Adobe Commerce徽标并从`magento/magento2`存储库的主自述文件中删除了无关空格。 Rafael Cora r̻Gomes在拉取请求[28891](https://github.com/magento/magento2/pull/28891)_中提交的_&#x200B;修复。 [GitHub-29056](https://github.com/magento/magento2/issues/29056)
...
* 已重构该 `TierPriceManagement` 类以删除冗余代码。 _Lukasz Bajsarowicz 在拉取请求 [29202](https://github.com/magento/magento2/pull/29202)_ 中提交的修复。 [GitHub-29477](https://github.com/magento/magento2/issues/29477)

<!-- ENGCOM-7830-->

* `autoload.php` 已重构以提高可读性和返回速度。 _修复由 Vitaliy Ryaboy 在拉取请求 [28923](https://github.com/magento/magento2/pull/28923)_ 中提交。 [GitHub-29527](https://github.com/magento/magento2/issues/29527)
...
* 当购物者为可配置产品选择选项时，应用程序不再更新“相关产品”价格框。 以前，每当购物者为可配置产品选择选项时，应用程序都会更新价格框。
...
* 现在，单击“管理员”产品页面中可下载产品的&#x200B;**示例**&#x200B;按钮时，可按预期下载示例。 以前，单击“ **示例**”时，应用程序会显示此错误： `The product that was requested doesn't exist. Verify the product and try again`。

<!-- ENGCOM-7757-->

* 购物者现在可以下载缺货的可下载产品的样品。 以前，当购物者尝试下载样品时，应用程序会打开一个新选项卡，但不显示信息性消息或开始下载过程。 _修复由瓦迪姆·马莱什在拉取请求 [28898](https://github.com/magento/magento2/pull/28898)_ 中提交。 [GitHub-23638](https://github.com/magento/magento2/issues/23638)

<!-- ENGCOM-7796-->

* 改进了当购物者尝试为可下载产品设置送货地址时应用程序显示的异常消息。 _修复由 Michał Derlatka 在拉取请求 [28904](https://github.com/magento/magento2/pull/28904)_ 中提交。 [GitHub-26107](https://github.com/magento/magento2/issues/26107)
...
* 当Redis使用所有允许的内存时，应用程序不再引发以下严重错误： `report.CRITICAL: OOM command not allowed when used memory > 'maxmemory'.`

<!-- MC-18021-->

* 在禁用`Persistent`模块时，购物者现在可以将多个产品添加到购物车中。 [GitHub-14486](https://github.com/magento/magento2/issues/14486)

### 常规修复

<!-- MC-36048-->

* 现在，对管理员（**商店** > **属性** > **产品**）上的产品进行排序会显示符合搜索条件的所有产品。 以前，应用程序不显示记录，而要对记录进行排序，必须导航到搜索结果的首页。

<!-- MC-36343-->

* `tracking.phtml`中的URL周围不必要的引号和转义已被删除。
...
* JavaScript缩小功能现在可以正常使用。 缩小文件解析程序不再将变量泄露到全局范围。 以前，窗口下的`ctx`、`origNameToUrl`和`baseUrl`变量被泄漏。 _由Mateusz Krzeszowiak在拉取请求[中提交的修复27622](https://github.com/magento/magento2/pull/27622)_。 [GitHub-28110](https://github.com/magento/magento2/issues/28110)
...
* 购物者可以在结账时选择礼品消息选项。 GraphQL现在包含适用于各种购物车商品的礼品消息选项。 查看[`setGiftOptionsOnCart`突变](https://developer.adobe.com/commerce/webapi/graphql/mutations/set-gift-options.html)和[`updateCartItems`突变](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-cart-items.html)。 Oleh Usik在拉取请求[28519](https://github.com/magento/magento2/pull/28105)、[27956](https://github.com/magento/magento2/pull/27956)、[28072](https://github.com/magento/magento2/pull/28072)、[28072](https://github.com/magento/magento2/pull/28072)中提交的修复(_F)。 [GitHub-28519](https://github.com/magento/magento2/issues/28519)

<!-- ENGCOM-7508 -->

* 客户和来宾可以撰写产品评论。 客户还可以检索其产品审阅历史记录。 有关检索有关审阅基础结构的信息，请参阅[创建产品审阅](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-product-review.html)和[productReviewRatingsMetadata查询](https://developer.adobe.com/commerce/webapi/graphql/queries/product-review-ratings-metadata.html)。 _Eduard Chitoraga在拉取请求[中提交的修复27882](https://github.com/magento/magento2/pull/27882)_。 [GitHub-28523](https://github.com/magento/magento2/issues/28523)
...
* `updateCustomer`突变不再允许您在`gender`参数中设置无效的`INT`值。 _Alexander Taranovsky在拉取请求[中提交的修复28487](https://github.com/magento/magento2/pull/28487)_。 [GitHub-28481](https://github.com/magento/magento2/issues/28481)
...
* 现在， `categoryList` 查询在使用片段时返回正确的响应。 _Ulzii 在拉取请求 [28710](https://github.com/magento/magento2/pull/28710)_ 中提交的修复。 [GitHub-28584](https://github.com/magento/magento2/issues/28584)

<!-- ENGCOM-7732 7733-->

* GraphQL 产品搜索现在考虑配置的类别权限。 以前，产品搜索会忽略启用&#x200B;****&#x200B;设置（**目录**>**配置**> **** 商店>**目录**>**类别权限**）。_Petkovski Marjan在拉取请求 [28757](https://github.com/magento/magento2/pull/28757) 和私人存储库`partners-magento2ee`_&#x200B;中的拉取请求271中提交的修复。 [GitHub-28563](https://github.com/magento/magento2/issues/28563)

<!-- MC-31084-->

* 现在，您可以在购物车中的其他商品缺货时使用将产品添加到购物车 `addSimpleProductToCart` 。 以前，应用程序返回此错误： `Some of the products are out of stock`。 [GitHub-26683](https://github.com/magento/magento2/issues/26683)

* 默认的 GraphQL `Category` 方法现在按类别位置按预期排序。 _Derrik Nyomo 在拉取请求 [29301](https://github.com/magento/magento2/pull/29301)_ 中提交的修复。 [GitHub-104](https://github.com/magento/catalog-storefront/issues/104)

* 在Magento开源中添加了对愿望清单的支持。 您可以在[](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-wishlist.html)愿望清单中添加项目、[更新](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-products-in-wishlist.html)项目以及[从愿望清单中删除项目](https://developer.adobe.com/commerce/webapi/graphql/mutations/remove-products-from-wishlist.html)。_Eduard Chitoraga在拉取请求[中提交的修复28205](https://github.com/magento/magento2/pull/28205)_。 [GitHub-28551](https://github.com/magento/magento2/issues/28551)
...
* 更新了 GraphQL [`storeConfig` 查询](https://developer.adobe.com/commerce/webapi/graphql/queries/store-config.html) 以包含新的客户配置设置。 _Oleh Usik在拉取请求[中提交的修复27876](https://github.com/magento/magento2/pull/27876)_。 [GitHub-28521](https://github.com/magento/magento2/issues/28521)
...
* 在[Klarna的付款方式](https://developer.adobe.com/commerce/webapi/graphql/payment-methods/klarna.html)和[`createKlarnaPaymentsSession`](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-klarna-payments-session.html)中添加或更新了关于Klarna GraphQL的主题
...
* 导入的CSV文件现在会按预期捕获相关的产品信息。 以前，在第一次导入CSV文件时，上传的相关产品信息不一致。
...
* 在运行PHP 7.4.9的部署上加载目录和产品页时不再出现问题。 以前，当您尝试加载目录和产品页时，应用程序引发此错误： `There has been an error processing your request. Exception printing is disabled by default for security reasons`。 [GitHub-29502](https://github.com/magento/magento2/issues/29502)
...
* 拦截器生成已得到改进。 `} else {`语句已从侦听器中删除，`array_map`已替换`foreach`。 _由Lukasz Bajsarowicz在拉取请求[27902](https://github.com/magento/magento2/pull/27902)_&#x200B;中提交的修复。 [GitHub-28383](https://github.com/magento/magento2/issues/28383)
...
* 插件已迁移出框架，以遵循在框架命名空间中禁止插件的最佳实践。 Lukasz Bajsarowicz在拉取请求[中提交的&#x200B;_修复27965](https://github.com/magento/magento2/pull/27965)_。 [GitHub-27962](https://github.com/magento/magento2/issues/27962)
...
* 添加了扩展点以支持将HTML添加到“类别”页面。 此操作可更正由上一个提取请求引入的错误。 _由iGerchak在拉取请求[中提交的修复29291](https://github.com/magento/magento2/pull/29291)_。 [GitHub-29286](https://github.com/magento/magento2/issues/29286)

### 分层导航

<!-- MC-25043-->

* 分层导航侧边栏现在显示同时具有选项（**是**/**否**）和匹配产品计数的Boolean属性。 以前，使用Elasticsearch的部署中的布尔属性不会返回一个&#x200B;**no**&#x200B;选项。

<!-- ENGCOM-7493-->

* 色板分层导览滤镜现在与整个Magento Open Source中使用的标准滤镜保持一致。 _由Bartlomiej Szubert在拉取请求[28015](https://github.com/magento/magento2/pull/28015)_&#x200B;中提交的修复。 [GitHub-28011](https://github.com/magento/magento2/issues/28011)
...
* 添加了`StorefrontShareCustomerWishlistActionGroup`测试，用于使用无效电子邮件地址共享客户希望列表。 希望列表共享的现有测试(`StorefrontShareWishlistEntityTest`)已重构。 `StorefrontCustomerShareWishlistActionGroup`已弃用。
...
* 现在，使用`EXCEL XML`选项导出新闻稿订阅者列表时，所有行都会按预期方式导出。 以前，导出的数据仅包含页面分页值，而不包含所有行。
...
* 总金额为零的贷项通知单的订单状态为`Closed`。 以前，应用程序将其订单状态报告为`Complete`。 _由Andrii Kalinich在拉取请求[29023](https://github.com/magento/magento2/pull/29023)_&#x200B;中提交的修复。 [GitHub-22762](https://github.com/magento/magento2/issues/22762)

### 付款方式

<!-- MC-34363-->

* 现在，当您为管理员订单单击&#x200B;**提交**&#x200B;时，应用程序会显示一条消息，提示您输入必填的信用卡数据，而无需输入有效的付款信息。 以前，当付款输入字段无效并且页面变为不活动时，Braintree卡验证器不会引发错误。
...
* 当您首次完成另一张订单后通过关闭PayPal付款弹出窗口来取消订单时，应用程序不会再清空您的购物车。
...
* 现在，应用程序会按需加载相应的滑块构件，从而改进了页面加载。 触控滑块构件自定义已移至单独的文件，因此只能在兼容设备上加载。 现在，仅当页面上实际使用范围绑定时，才加载适当的滑块构件类型。 _Mateusz Krzeszowiak在拉取请求[中提交的修复27616](https://github.com/magento/magento2/pull/27616)_。 [GitHub-28807](https://github.com/magento/magento2/issues/28807)
...
* Elasticsearch结果现在包含每个商店视图属性选项的正确值。 如果`Dropdown`或`Multiple Select`属性在非默认存储视图中的选项值不同于默认存储视图中的选项值，则Elasticsearch现在会对该值进行索引或在结果中返回具有该值的产品。 以前，Elasticsearch不对该值进行索引，也不在结果中返回具有该值的产品。
...
* `robots.txt`中的站点地图现在特定于商店。 _由Vadim Malesh在拉取请求[中提交的修复29331](https://github.com/magento/magento2/pull/29331)_。 [GitHub-28901](https://github.com/magento/magento2/issues/28901)

<!-- MC-34617-->

* 编码值现在可以在`sitemap.xml`文件中正确转义。 以前，当您在产品名称或图像标题中包含编码字符时，生成的站点地图无效。
...
* 集成测试现已涵盖`SynchronizeFilesInterface`。 _jmonteros422 在拉取请求 [29493](https://github.com/magento/magento2/pull/29493)_ 中提交的修复。 [GitHub-1742](https://github.com/magento/magento2/issues/1742)

<!-- ENGCOM-8009-->

* 添加了一个函数， `\Magento\TestFramework\TestCase\WebapiAbstract` 可以比较测试中预期结果和实际结果的大型嵌套数组，并允许测试人员忽略实际结果中不相关的键。 _Jekabs 在拉取请求 [29458](https://github.com/magento/magento2/pull/29458)_ 中提交的修复程序。 [GitHub-29498](https://github.com/magento/magento2/issues/29498)

<!-- ENGCOM-7887 -->

* 在`app/code/Magento/Newsletter/Test/Unit/Model/SubscriptionManagerTest.php`中修正了预期值与实际值的反转。 Lukasz Bajsarowicz在拉取请求[中提交的&#x200B;_修复29271](https://github.com/magento/magento2/pull/29271)_。 [GitHub-29283](https://github.com/magento/magento2/issues/29283)
...
* 在测试期间使用`ObjectManager`实例化类已被单元测试中的新关键字替换。 Lukasz Bajsarowicz在拉取请求[中提交的&#x200B;_修复29272](https://github.com/magento/magento2/pull/29272)_。 [GitHub-29346](https://github.com/magento/magento2/issues/29346)
...
* 现在可以在管理员&#x200B;**商店** > **配置** > **销售** > **税费** > **固定产品税费**&#x200B;上翻译术语FPT。 _由Vadim Malesh在拉取请求[中提交的修复28108](https://github.com/magento/magento2/pull/28108)_。 [GitHub-5477](https://github.com/magento/magento2/issues/5477)

<!-- ENGCOM-7631 -->

* 已更改结帐工作流程送货地址模式上的&#x200B;**在此处运送**&#x200B;按钮标签，以匹配用于其他按钮的驼峰式大小写。 现在，此案例与翻译文件中使用的案例匹配。 以前，由于大小写不匹配，因此不翻译此标签。 _WK在拉取请求[中提交的修复28547](https://github.com/magento/magento2/pull/28547)_。 [GitHub-28685](https://github.com/magento/magento2/issues/28685)
...
* 直接单击“添加新税则”页面的&#x200B;**导出税率**&#x200B;按钮（**商店** > **税则**），现在可按预期下载`tax_rates.csv`文件。 以前，商家必须单击&#x200B;**出口税率**&#x200B;按钮的边缘。 这是2.4.0中的已知问题。

<!-- MC-35313-->

* 购物车底部的&#x200B;**将选定内容添加到购物车**&#x200B;按钮现在可按预期工作。 这是2.4.0中的已知问题。

<!-- MC-35296-->

* 客户活动页面的&#x200B;**最近查看的产品**&#x200B;部分的&#x200B;**刷新**&#x200B;按钮现在可正常工作。 以前，当您单击“**刷新**”时，产品列表未刷新，页面已滚动。

<!-- MC-35412-->

* 应用程序现在会在&#x200B;**客户** > **区段** > **添加区段**&#x200B;的“条件”选项卡上正确显示用于选择客户出生日期的日历图标。
...
* 现在，在更新PUT为`V1/customers/:id`的终结点的客户时，可以指定单个字段。 以前，该端点要求您指定客户电子邮件以及创建客户所需的其他字段。 _由Vadim Malesh在拉取请求[中提交的修复28332](https://github.com/magento/magento2/pull/28332)_。 [GitHub-21237](https://github.com/magento/magento2/issues/21237)

### 愿望列表

<!-- MC-35622-->

* 客户现在可以从愿望列表本身更改愿望列表中产品的数量。 以前，应用程序不更新产品数量，也不显示消息。
...
* 添加了用于与超过允许数量的电子邮件共享客户愿望列表的测试。 _修复由 Dmitry Tsymbal 在拉取请求 [28641](https://github.com/magento/magento2/pull/28641)_ 中提交。 [GitHub-28720](https://github.com/magento/magento2/issues/28720)

<!-- ENGCOM-7674-->

* 添加了以管理员用户身份从客户愿望清单中删除项目的测试。 _Dmitry Tsymbal 在拉取请求 [28632](https://github.com/magento/magento2/pull/28632)_ 中提交的修复。 [GitHub-28721](https://github.com/magento/magento2/issues/28721)
...
**问题**：当购物者选择与账单地址不同的收货地址时，顶点地址验证在付款期间不起作用。 此问题将在2.4.2中修复。查看[2.4.1已知问题：更新地址](https://support.magento.com/hc/en-us/articles/360050139631)知识库文章后，顶点地址验证消息未消失。
