...
* 现在，GraphQL URL解析程序可正确处理查询参数。 以前，在处理带有参数的SEO友好URL时返回NULL。

<!-- ENGCOM-8422 -->

* 现在，GraphQL URL解析程序可正确处理CMS页面层次结构。 以前，返回NULL。 [GitHub-30474](https://github.com/magento/magento2/issues/30474)
