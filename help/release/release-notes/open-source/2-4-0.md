...
* **删除第三方付款方法的核心集成**。 在此版本中，已从核心代码中删除Authorize.Net支付方法集成。 商家应该迁移到Commerce Marketplace上提供的官方扩展。 查看[弃用付款集成](https://experienceleague.adobe.com/en/docs/commerce-admin/start/compliance/payments/compliance-payment-services-directive).<!-- MC-29029-->
