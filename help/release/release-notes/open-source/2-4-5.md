...
* 修复了`catalogsearch/advanced/result`和`catalogsearch/advanced/index`页面上的PHP错误。  以前，当数组在任何高级搜索字符串中传递时，Magento Open Source会显示此错误： `Warning: trim() expects parameter 1 to be string, array given | magento/module-catalog-search`。 [GitHub-33586](https://github.com/magento/magento2/issues/33586)
