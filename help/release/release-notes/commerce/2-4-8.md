...
<table style="table-layout:auto">
    <tbody>
        <tr>
            ...
            <td>此版本包括以下安全设置增强功能：
              <ul>
                <li><strong>Duo Security 2FA</strong>：此更改将更新Adobe Commerce中的<a href="https://experienceleague.adobe.com/en/docs/commerce-admin/systems/security/tfa/security-two-factor-authentication-use#duo-security">Duo Security</a>双重身份验证(2FA)实现以使用最新的SDK (Web SDK v4)。 此升级使商家能够无缝过渡到使用Duo通用提示。 商家必须在管理员设置中更新其配置，以包含客户端ID和密码。<!-- AC-10982 --></li>
...
<table style="table-layout:auto">
    <tbody>
        ...
        <tr>
            ...
            <td>此版本添加了对RabbitMQ 4.x的支持。 在升级到RabbitMQ 4之前，Adobe Commerce Cloud和本地客户必须<a href="https://www.rabbitmq.com/docs/3.13/migrate-mcq-to-qq">从[!DNL classic mirrored queues]迁移到[!DNL quorum queues]</a>。 此迁移是必需的，因为：<ul>
        ...
        <tr>
            ...
            <td>Adobe Commerce现在已针对OpenSearch 2.19进行了优化，并且不再与Elasticsearch兼容。 代码库中现在已弃用所有Elasticsearch 7和8模块和类。 Adobe强烈建议转为使用OpenSearch进行内部部署和云基础架构部署，以确保持续的支持和兼容性。 请参阅<a href="/help/upgrade/prepare/opensearch-migration.md">迁移到OpenSearch</a>。<ul>
...
<table style="table-layout:auto">
    <tbody>
        ...
        <td>
            <ul>
                <li><!--LYNX-387-->已将以下新字段添加到<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartitemprices"><code>CartItemPrices</code></a>类型以支持精确的定价显示和折扣计算：
                <ul>
              ...
              <li><!--LYNX-542-->更新了<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/cart/mutations/update-items"><code>updateCartItems</code></a>突变，以返回包含错误详细信息而不是异常的成功响应。 增强了错误映射功能，提高了用户通知的清晰度。</li>
              ...
              <li><!--LYNX-451-->已将<code>grand_total_excluding_tax</code>字段添加到<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartprices"><code>CartPrices</code></a>类型，从而提供了明确的含税定价。</li>
              <li><!--LYNX-377-->已将<code>not_available_message</code>添加到<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/cart/interfaces/"><code>CartItemInterface</code></a>。</li>
            </ul>
        </td>
       </tr>
        <tr>
           ...
           <td>此版本包括以下客户管理增强功能：
             <ul>
               <li><!--LYNX-391-->改进了<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/customer/mutations/generate-token"><code>generateCustomerToken</code></a>突变中的错误处理，为未确认的电子邮件提供特定消息。 支持更好的用户指导和错误解决。</li>
        ...
        <tr>
           ...
           <td>此版本包括以下用户订单管理增强功能：
             <ul>
              ...
              <li><!--LYNX-470-->已将新的<code>date_of_first_order</code>字段添加到<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorders"><code>CustomerOrders</code></a>类型。</li>
              <li><!--LYNX-468-->扩展了<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#orderaddress"><code>OrderAddress</code></a>类型以包含自定义属性，增强了订单详细信息的可见性。 支持在订单确认页面上显示附加信息。</li>
              <li><!--LYNX-450-->已将<code>is_virtual</code>字段添加到<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a>类型，支持虚拟产品标识。 通过区分虚拟产品和物理产品来增强订单处理。</li>
              <li><!--LYNX-449-->向<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#orderiteminterface"><code>OrderItemInterface</code></a>添加了与<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartitemprices"><code>CartItemPrices</code></a>类似的<code>OrderItemPrices</code>类型，其中包含多个新的价格字段。</li>
              <li><!--LYNX-448-->改进了API功能，以便根据电子邮件匹配将访客订单与客户帐户合并。 简化回头客户的订单管理。</li>
              <li><!-- LYNX-523: -->扩展了<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a>类型以包含<code>available_actions</code>字段，以便更好地进行订单管理。 “available_actions”字段映射到枚举，其中列出了可以对订单执行的操作。</li>
              <li><!-- LYNX-524 -->已将<code>customer_info</code>字段添加到<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a>类型。 此字段需要<code>OrderCustomerInfo</code>类型，其中包含有关客户名称的详细信息。</li>
              <li><!--LYNX-519-->向<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cancelorderoutput"><code>CancelOrderOutput</code></a>类型添加了详细的错误代码。 改进了订单取消流程的错误处理和用户反馈。</li>
              ...
              <li><!--LYNX-642-->更新了<code>order.availableActions</code>字段以确保在商家<a href="https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/shopper-tools/reorders-allow#configure-to-allow-customer-reorders">禁用</a>管理员中的重新排序功能时未返回<code>REORDER</code>操作。</li>
              ...
              <li><!--LYNX-470-->添加了基于<code>created_at</code>字段的订单历史记录筛选器，并公开了<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorders"><code>CustomerOrders</code></a>类型的<code>date_of_first_order</code>。</li>
              <li><!--LYNX-450-->已将<code>is_virtual</code>字段添加到<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a>类型，类似于<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cart"><code>Cart</code></a>类型。 这允许客户有条件地隐藏仅包含虚拟产品的订单的送货信息。</li>
              ...
              <li><!--LYNX-701-->更新了<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#customerorder"><code>CustomerOrder</code></a>类型以包含应用于订单总计的商店积分和奖励积分。 现在，订单有效负荷会返回商店点数和奖励分数的标签和值，从而确保完整的成本汇总详细信息。</li>
            </ul>
           </td>
        </tr>
        <tr>
        ...
        <td>
            <ul>
              <li><!--LYNX-540-->在<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#productinterface"><code>ProductInterface</code></a>中添加了<code>quantity</code>字段以提供库存级别详细信息。 根据管理员设置，它会显示可用库存或空值。</li>
              <li><!--LYNX-460-->更正了捆绑产品的定价显示，以确保准确的价格和货币信息。</li>
              <li><!--LYNX-401-->已将<code>grouped_product_image</code>和<code>configurable_product_image</code>字段添加到<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-q-s#storeconfig"><code>StoreConfig</code></a>类型。</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
              <li><!--LYNX-713-->更新了<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-f-i#giftoptionsprices"><code>GiftOptionsPrices</code></a>和<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#ordertotal"><code>OrderTotal</code></a>类型，以包含礼品包装（按物料和订单）和打印卡片的<code>price_excluding_tax</code>和<code>price_including_tax</code>字段。 此增强功能可确保根据购物车和订单查询的存储配置设置准确显示税金。</li>
              ...
              <li><!--LYNX-693-->已将<code>gift_message</code>和<code>gift_wrapping</code>字段添加到<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-f-i#giftcarditem"><code>GiftCardCartItem</code></a>类型；已更新逻辑以放弃虚拟产品的礼品包装。</li>
    ...
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-632-->更新了RMA项输入的<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/mutations#requestreturn"><code>requestReturn</code></a>突变，以解决返回属性相关查询与突变之间的不一致。</li>
                <li><!--LYNX-515-->更新了<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/mutations#requestreturn"><code>requestReturn</code></a>突变以支持来宾订单退货。</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-633-->使用字段更新了<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-q-s#storeconfig"><code>StoreConfig</code></a>类型，以匹配管理员配置中的税务显示设置。</li>
                <li><!--LYNX-697-->已将<code>subtotal_excl_tax</code>和<code>subtotal_incl_tax</code>字段添加到<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-k-p#ordertotal"><code>OrderTotal</code></a>类型。 已将<code>subtotal</code>字段标记为已弃用。</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-618-->为<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-c-e#cartaddressinterface"><code>CartAddressInterface</code></a>类型的送货或帐单购物车地址中的通讯簿添加了标识符。</li>
                <li><!--LYNX-617-->已将<code>same_as_billing</code>字段添加到<a href="https://developer.adobe.com/commerce/webapi/reference/graphql/2-4-8/types-q-s#shippingcartaddress"><code>ShippingCartAddress</code></a>类型，该字段指示送货地址和帐单地址是否相同。</li>
                <li><!--LYNX-458-->已更新<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order"><code>guestOrder</code></a>和<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order-by-token"><code>guestOrderByToken</code></a>查询以包含自定义地址属性，从而确保新帐户的完整地址信息。</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-522-->向<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/store/queries/recaptcha-v3-config"><code>recaptchaV3Config</code></a>查询添加了<code>theme</code>字段。 此字段允许您指定用于呈现reCaptcha的主题名称，以确保价格和货币信息准确无误。</li>
