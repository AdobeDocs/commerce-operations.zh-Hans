...
<table style="table-layout:auto">
    <tbody>
        ...
        <tr>
            ...
            <td>为了尽可能减少混淆，[!UICONTROL Submit Comment]订单详细信息[!UICONTROL Update]页面中的<a href="https://experienceleague.adobe.com/zh-hans/docs/commerce-admin/stores-sales/order-management/orders/order-processing#notes-for-this-order">按钮标签已更改为</a>。</td>
        </tr>
    </tbody>
</table>
        ...
        <tr>
           ...
           <td>此版本包括以下用户订单管理增强功能：
             <ul>
              ...
              <li><!--LYNX-642-->更新了<code>order.availableActions</code>字段以确保在商家<code>REORDER</code>禁用<a href="https://experienceleague.adobe.com/zh-hans/docs/commerce-admin/stores-sales/shopper-tools/reorders-allow#configure-to-allow-customer-reorders">管理员中的重新排序功能时未返回</a>操作。</li>
