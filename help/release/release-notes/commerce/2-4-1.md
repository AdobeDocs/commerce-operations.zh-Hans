...
* 在使用编辑器安装Adobe Commerce后，您现在可以使用`bin/magento sampledata:deploy`按预期部署示例数据。 以前，应用程序引发此错误： `Git installations must deploy sample data from GitHub; see /help/installation/sample-data/git-repositories.md for more information`。 _Andrii Beziazychnyi在拉取请求[中提交的修复27481](https://github.com/magento/magento2/pull/27481)_。 [GitHub-19481](https://github.com/magento/magento2/issues/19481)
