...
* GraphQL现在支持为具有选项类型的捆绑产品下订单 `radio` 和 `dropdown` 有多种选择。 以前，应用程序会显示一条消息，说明 `BundleItem.type: radio/dropdown`. _由Michał Derlatka在拉取请求中提交的修复 [29256](https://github.com/magento/magento2/pull/29256)_. [GitHub-26110](https://github.com/magento/magento2/issues/26110)
...
* 现在，相关产品的GraphQL查询会返回从目标规则创建的相关产品的值。 以前，仅当从产品设置中添加了相关产品时，才会查询相关产品（向上销售和交叉销售）返回值。 _修复了Ulzii在private repo partners-magento2ee的拉取请求288中提交的问题_. [GitHub-28566](https://github.com/magento/magento2/issues/28566)
...
* 添加了有关中Klarna GraphQL的讨论 [克拉纳的支付方式](https://devdocs.magento.com/guides/v2.4/graphql/payment-methods/klarna.html) 和[`createKlarnaPaymentsSession`](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-klarna-payments-session.html)
...
* 现在，应用程序可正确验证购物者可以创建的最大愿望列表允许数。 _由Eduard Chitoraga在专用存储库合作伙伴 — magento2ee的拉取请求247中提交的修复_.
