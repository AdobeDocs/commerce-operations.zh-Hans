...
由[Adobe Sensei](https://www.adobe.com/sensei.html)提供支持的[实时搜索](https://docs.magento.com/user-guide/live-search/overview.html)通过使用人工智能和机器学习算法来对汇总的访客数据进行深入分析，提供了直观的搜索体验。 请参阅[实时搜索发行说明](https://experienceleague.adobe.com/docs/commerce-merchant-services/live-search/release-notes.html)。
...
* **愿望清单**。 [addWishlistItemsToCart突变](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-wishlist-items-to-cart.html)将项目从指定的愿望清单移至客户的购物车。<!-- magento/partners-magento2ee#449-->

* **礼品登记簿**。 涵盖的任务包括： <!-- PWA-1290-->

   * 使用[giftRegistry查询](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry.html)返回客户礼品注册的内容。

   * 按[类型](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry-type-search.html)、[电子邮件](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry-email-search.html)或[ID](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry-id-search.html)搜索礼品注册表。

   * [创建](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-gift-registry.html)、[更新](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-gift-registry.html)或[删除](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-gift-registry.html)礼品注册表。

   * [更新](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-gift-registry-items.html)或从礼品注册表中删除](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-gift-registry-items.html)个项目。[

   * [将所有商品](https://devdocs.magento.com/guides/v2.4/graphql/mutations/move-cart-items-to-gift-registry.html)从购物车移至礼品注册表。<!-- ENGCOM-9082 9087-->

   * 从礼品注册表中添加[1}、[更新](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-gift-registry-registrants.html)或[删除](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-gift-registry-registrants.html)注册者。](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-gift-registry-registrants.html)

   * [与被邀请者共享](https://devdocs.magento.com/guides/v2.4/graphql/mutations/share-gift-registry.html)礼品注册表。

* **可协商的引号**。 查看[`negotiableQuote`](https://devdocs.magento.com/guides/v2.4/graphql/queries/negotiable-quote.html)和[`negotiableQuotes`](https://devdocs.magento.com/guides/v2.4/graphql/queries/negotiable-quotes.html)查询。<!-- PWA-1292-->
...
* **共享路由**。 [路由查询](https://devdocs.magento.com/guides/v2.4/graphql/queries/route.html)和[RoutableInterface](https://devdocs.magento.com/guides/v2.4/graphql/interfaces/routable-interface.html)支持产品、类别和CMS页面上的路由请求。 `urlResolver`查询已弃用，其功能已被`route`查询取代。
...
* 在使用GET`/rest/V1/products/?searchCriteria[filterGroups]`的产品搜索中按位置排序现在按预期工作。 以前，产品收藏集没有用于排序的字段`position`值。 [GitHub-31591](https://github.com/magento/magento2/issues/31591)
...
* [`dynamicBlocks`查询](https://devdocs.magento.com/guides/v2.4/graphql/queries/dynamic-blocks.html)返回与指定筛选器匹配的动态块的内容。
