...
由[Adobe AI](https://experienceleague.adobe.com/en/docs/commerce/live-search/overview)提供支持的[实时搜索](https://business.adobe.com/ai.html)通过使用人工智能和机器学习算法执行对汇总的访客数据的深入分析，提供了直观的搜索体验。 请参阅[实时搜索发行说明](https://experienceleague.adobe.com/docs/commerce/live-search/release-notes.html)。
