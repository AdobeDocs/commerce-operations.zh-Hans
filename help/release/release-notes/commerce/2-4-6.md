...
Adobe Commerce 2.4.6-beta2已针对以下组件版本进行了测试：
...
Adobe Commerce 2.4.6-beta2引入了对PHP 8.2的支持。PHP 8.1仍完全受支持。  <!-- AC-6598 -->

此版本中移除了对PHP 7.4的支持。 不能在PHP 7.4上运行Adobe Commerce。

Adobe Commerce 2.4.6-beta2现在支持：
...
我们正在修复Adobe Commerce 2.4.6核心代码中的数百个问题。 下面介绍了Adobe Commerce 2.4.6-beta2中包含的已修复问题的子集。
...
* GraphQL查询响应现在包含有关捆绑产品子产品的信息 `product` 部分 `options` 块。
...
* 客户 `order` 查询现在会按照预期从所有指定的网站、商店和商店视图返回订单。 此修复包括创建新请求参数。
