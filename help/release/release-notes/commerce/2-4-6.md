...
PHP 7.4支持已从此版本中删除。 无法在PHP 7.4上运行Adobe Commerce。
...
* [Bolt快速签出](https://help.bolt.com/shoppers/about/)
...
* Adobe Commerce现在在以下情况下返回信息性消息： `addProductsToCart` 将产品添加到购物车时权限不足，查询失败。
...
* Adobe Commerce不再错误地基于类别路径假定一个类别是另一个类别的父级。 [GitHub-32464](https://github.com/magento/magento2/issues/32464)
...
* 现在，高级库存中某个产品的“允许多个发货箱”属性的值按预期保存。
