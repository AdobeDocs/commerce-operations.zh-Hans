...
* **为管理员帐户、magento.com用户帐户和Cloud SSH访问实施2FA**
   ...
   * **保护你的管理员帐户**。 管理员现在需要双重身份验证(2FA) 。 管理员用户必须先配置其2FA，然后才能通过UI或Web API登录到管理员。 2FA默认处于启用状态。 我们强烈建议不要禁用2FA模块。  这一额外的身份验证步骤使得恶意用户更难以未经授权登录到管理员。 请参阅[双重身份验证(2FA)](https://developer.adobe.com/commerce/testing/functional-testing-framework/two-factor-authentication/)。<!-- MC-22631-->
...
* **模板筛选器严格模式现在默认启用**。 在旧模式下使用模板过滤器的组件(包括CMS页面和块)容易遭受远程代码执行(RCE)的攻击。 默认情况下，启用严格模式可确保不会蓄意启用RCE攻击。 <!-- MC-22982-->
...
* JavaScript mixin 模块已经过重构，以改进高级捆绑模块对 mixin 的加载和应用。 以前，应用程序不会为高级捆绑模块加载或应用mixin。  _Mateusz Krzeszowiak在拉取请求[中提交的修复25587](https://github.com/magento/magento2/pull/25587)_。 [GitHub-25586](https://github.com/magento/magento2/issues/25586)

<!-- ENGCOM-6344-->

* 该 `grunt clean` 命令现在可以按预期清理生成的代码和元数据文件夹。 _Andrii Beziazychnyi 在拉取请求 [25765](https://github.com/magento/magento2/pull/25765)_ 中提交的修复。 [GitHub-25739](https://github.com/magento/magento2/issues/25739)
...
* 已删除将第三方支付方法Authorize.Net、eWay、CyberSource、Braintree和Worldpay集成到核心代码中。 商家应迁移到Commerce Marketplace上提供的官方扩展。
...
* 切换账单地址不再导致JavaScript函数文本显示在店面结账工作流程的付款部分中。 _由Chris Pook在拉取请求[26378](https://github.com/magento/magento2/pull/26378)_&#x200B;中提交的修复。 [GitHub-26375](https://github.com/magento/magento2/issues/26375)

<!-- ENGCOM-7223-->

* 贷项通知单现在在〖贷项通知单〗概览的〖调整退款&#x200B;**〗字段中显示正确的金额**。_Sergiy Vasiutynskyi 在拉取请求 [27343](https://github.com/magento/magento2/pull/27343)_ 中提交的修复。 [GitHub-13851](https://github.com/magento/magento2/issues/13851)

<!-- ENGCOM-6524-->

* 现在，您可以在保存报价后从 `quote_payment column additional_information` 表中删除其他信息。 以前，无法在保存报价后删除此信息，因为 `unsAdditionalInformation` 中 `\Magento\Payment\Model\Info` 的方法未正确初始化数据。  _修复由马可·奥利维拉在拉取请求 [26084](https://github.com/magento/magento2/pull/26084)_ 中提交。 [GitHub-26083](https://github.com/magento/magento2/issues/26083)
...
* 现在，每当客户在结账工作流程中输入无效的送货地址后单击“ **PayPal** 付款”时，该应用程序都会显示一条信息性错误消息。 以前，应用程序仅在客户首次单击按钮时显示错误消息，而不会在后续单击时显示错误消息。
...
* 使用PayPal Payflow Pro 下达的订单现在 `Suspected Fraud` 设置为触发欺诈过滤器时的状态。

<!-- MC-33110-->

* 现在，您可以使用任何支持的信用卡使用 PayPal 快速结账服务。 以前，当您在使用 PayPal 快速结账完成订单时单击信用卡按钮时，应用程序会挂起，并且您无法输入任何信用卡信息。

<!-- MC-33117-->

* 在 PayPal Payflow Pro 中下达的订单现在 `Suspected Fraud` 设置为触发欺诈过滤器时的状态。 以前，在应用程序端进行付款审批之前，不会验证 PayPal 上的付款交易状态。

<!-- MC-33294-->

* 启用网站限制后，Payflow Pro 现在可以按预期工作。

<!-- MC-31196-->

* 该应用程序现在已成功处理通过 PayPal Express Checkout 下达的订单，其中订单的送货地址指定了客户在文本字段中手动输入的国家/地区，而不是从“发货”页面上的下拉菜单中选择的国家/地区。 以前，应用程序在订单审核页面上显示此错误： `Error 500: NOTICE: PHP message: PHP Fatal error: Uncaught Error: Call to a member function getId() on null in httpdocs/vendor/magento/module-paypal/Model/Api/Nvp.php:1527`。 [GitHub-26698](https://github.com/magento/magento2/issues/26698)
...
* 现在，此应用产品会为包含折扣的订单正确计算退款。 以前，应用程序计算运费和运费折扣的方式不正确，并且退款总额与已付总额不匹配。

<!-- MC-33165-->

* 现在，当新客户在多站点部署中创建订单时，应用程序会分配正确的组ID。 之前，应用程序会应用默认客户组中的设置。

<!-- MC-31786-->

* 具有查看贷项通知单、发票和发运的受限权限管理员现在可以按预期从“订单”页面查看发票和发运。 以前，当受限管理员尝试查看订单时，应用程序会显示此错误： `Something went wrong with processing the default view and we have restored the filter to its original state`。

<!-- MC-24023-->

* 当客户向购物车添加的产品数量超过现有产品库存的一半但未超过产品库存总量时，应用产品不再显示错误。 以前，在这些情况下，应用程序显示以下错误： `The requested qty is not available`。 [Github-24365](https://github.com/magento/magento2/issues/24365)

<!-- ENGCOM-6910-->

* 现在，当库存数量为1时，您可以从管理员成功将产品添加到购物车。 以前，应用程序未将产品添加到购物车并显示以下消息： `The requested qty is not available`。 _由Serhii Petrychenko在拉取请求[26650](https://github.com/magento/magento2/pull/26650)中提交的修复。_ [GitHub-25675](https://github.com/magento/magento2/issues/25675)

<!-- ENGCOM-7090-->

* 现在，当商店管理员尝试对其自定义选项的名称超过最大字符数的产品重新排序时，应用程序会显示一条信息性错误消息。 以前，在这些情况下，应用程序显示报告页面，而不是消息。 _Mudit Shukla在拉取请求[中提交的修复26348](https://github.com/magento/magento2/pull/26348)_。 [GitHub-26345](https://github.com/magento/magento2/issues/26345)

<!-- ENGCOM-6328-->

* 已重构 销售订单地址信息编辑 窗体的布局，以匹配管理员窗体库约定。 _阿列克谢·拉基廷在拉取请求 [25699](https://github.com/magento/magento2/pull/25699)_ 中提交的修复。 [GitHub-19805](https://github.com/magento/magento2/issues/19805)
...
* `getCustomer`方法现在返回`phpdoc`块中定义的客户对象。 以前此方法返回 `NULL`，块 `phpdoc` 没有突出显示此方法可以返回 `NULL`。 _Fanis Strezos 在拉取请求 [26423](https://github.com/magento/magento2/pull/26423)_ 中提交的修复。 [GitHub-25268](https://github.com/magento/magento2/issues/25268)

<!-- ENGCOM-6492-->

* 现在，当商家禁用&#x200B;****&#x200B;管理>**商店**>**配置**>**销售**>**重新订购**>**允许订单**&#x200B;时，重新订购将按预期禁用。_由Eden Duong在拉取请求[26051](https://github.com/magento/magento2/pull/26051)_&#x200B;中提交的修复。 [GitHub-25130](https://github.com/magento/magento2/issues/25130)

<!-- ENGCOM-6627-->

* 在Admin中为订单设置自定义价格时，`getPrice()`方法现在返回浮点或null，而不是字符串。  _由Andrii Chorniy在拉取请求[中提交的修复26313](https://github.com/magento/magento2/pull/26313)_。 [GitHub-25968](https://github.com/magento/magento2/issues/25968)

<!-- ENGCOM-6786-->

* **管理员** > **商店** >“设置”>“**订单状态**”的&#x200B;**状态代码和标题**&#x200B;列现在显示状态，而不是按预期显示状态。  _Oleh Usik在拉取请求[中提交的修复26569](https://github.com/magento/magento2/pull/26569)_。 [GitHub-17847](https://github.com/magento/magento2/issues/17847)
...
* Elasticsearch7.6.x现在是Adobe Commerce和Adobe Commerce的默认目录搜索引擎。 如果不安装Elasticsearch7.6.x，则无法安装或升级到版本2.4.0。已删除Elasticsearch版本2.x代码。 Elasticsearch版本5.x和6.x已弃用，不再受支持。 请参阅[搜索引擎先决条件](../../../installation/prerequisites/search-engine/overview.md)。
...
* 商家现在可以使用“品牌旗舰店&#x200B;**属性”>**“产品>**新属性**”上的&#x200B;******“视觉色板**”选项成功地&#x200B;**将色板属性添加到产品>**。以前，当您尝试打开新创建的色板属性时，会触发 JavaScript 错误。

<!-- ENGCOM-6750-->

* 现在，当客户为可配置产品选择新的色板选项时，最低广告价格会按预期更改。 _Sergiy Vasiutynskyi在拉取请求[中提交的修复26241](https://github.com/magento/magento2/pull/26241)_。 [GitHub-26240](https://github.com/magento/magento2/issues/26240)
...
* 测试已重构， `AdminReorderWithCatalogPrice` 在 CI 验证过程中不再失败。 _Lukasz Bajsarowicz在私有存储库合作伙伴 — magento2ee_&#x200B;的拉取请求135中提交的修复。 [GitHub-26607](https://github.com/magento/magento2/issues/26607)

<!-- ENGCOM-6780 6795-->

* `AdminAddingNewOptionsWithImagesAndPricesToConfigurableProduct`和`StorefrontApplyPromoCodeDuringCheckout`测试已重构，在 CI 验证过程中不再失败。_Lukasz Bajsarowicz 在拉取请求 26611](https://github.com/magento/magento2/pull/26611) 和拉取请求 [[26614](https://github.com/magento/magento2/pull/26614)_ 中提交的修复。[GitHub-26612](https://github.com/magento/magento2/issues/26612)，[GitHub-26610](https://github.com/magento/magento2/issues/26610)
...
* 我们解决了 `JsFooterPlugin.php` 影响动态块显示的错误。 以前，当您直接访问 `/banner/ajax/load/url`时，应用程序会显示此错误： `Uncaught TypeError: strpos() expects parameter 1 to be string, null given in`。

<!-- ENGCOM-6708-->

* 该方法`i18n`提供了将字符串添加到下划线模板的功能。  _Sergiy Vasiutynskyi 在拉取请求 [26435](https://github.com/magento/magento2/pull/26435)_ 中提交的修复。 [GitHub-18012](https://github.com/magento/magento2/issues/18012)

<!-- ENGCOM-6666-->

* 模块 `section-config` 已重构。 此重构减少了由 初始化`data-mage-init`模块之前直接发出 POST 请求或请求客户数据的第三方模块导致的错误。 _Mateusz Krzeszowiak在拉取请求[中提交的修复25764](https://github.com/magento/magento2/pull/25764)_。 [GitHub-17125](https://github.com/magento/magento2/issues/17125)
...
* 现在，Chrome浏览器上的TinyMCE4可按预期处理双字节字符。 以前，TinyMCE4无法在Chrome上正确处理双字节字符（如中文字符）。 _西博和在拉取请求[25454](https://github.com/magento/magento2/pull/25454)_&#x200B;中提交的修复。 [GitHub-24637](https://github.com/magento/magento2/issues/24637)
...
**问题**：商家无法从管理员创建新订单，因为&#x200B;**按SKU添加产品**&#x200B;和&#x200B;**添加产品**  启用JavaScript捆绑功能后，“订单创建”页面中缺少按钮。  **解决方法**：为您的部署禁用JavaScript绑定。<!-- MC-36044-->
...
**问题**：当订单列表跨多页时，客户无法更改每页显示的订单数。 目前，当您导航到订单的最后一页并尝试更改每页显示的订单数时，应用程序会显示此消息： `You have placed no orders`。 请参阅[订单显示错误](https://support.magento.com/hc/en-us/articles/360046802271)知识库文章。  **解决方法**：重新打开“我的订单”页面将导致显示“订单”列表。<!-- MC-34153-->

**问题**：直接单击“添加新税则”页面（**商店** > **税则**）的&#x200B;**导出税率**&#x200B;按钮无法按预期下载`tax_rates.csv`文件。 **解决方法**：单击&#x200B;**导出税率**&#x200B;按钮的边缘。  请参阅[导出税率不起作用](https://support.magento.com/hc/en-us/articles/360045850032)知识库文章。<!-- MC-35345-->

**问题**：“管理客户活动”页面的“上次订购的商品”、“比较列表中的产品”和“最近比较的产品”部分上的&#x200B;**刷新**&#x200B;按钮无法按预期工作。 目前，应用程序在每次单击&#x200B;**刷新**&#x200B;按钮时都会滚动页面，并且不显示产品名称。 请参阅[刷新客户活动不起作用](https://magento.zendesk.com/hc/en-us/articles/360046091332)知识库文章。<!-- MC-35296-->
...
* **问题**：应用程序打开&#x200B;**Sales** > **Braintree虚拟终端**&#x200B;时出错。 尽管表单包含损坏的UI元素，但仍接受付款。 **解决方法**：保存正确的Braintree凭据，这将修复折叠的输入字段。 请参阅[Braintree虚拟终端页已损坏](https://support.magento.com/hc/en-us/articles/360046800071)知识库文章。 此问题的&#x200B;**BUNDLE-2670_VirtualTerminal.patch**&#x200B;修补程序现在可从[版本](https://magento.com/tech-resources/download)获得。<!-- BUNDLE-2670-->
...
* **问题**：应用程序在签出工作流的装运部分上显示&#x200B;**地址验证**&#x200B;按钮，即使禁用地址验证也是如此。 地址验证器不会重新检查更新的地址，并且即使在启用了地址验证的情况下，当客户在首次输入错误的地址后输入正确的地址时，仍继续显示指示地址无效的消息。 **解决方法**：禁用顶点地址验证。<!-- BUNDLE-2604-->
...
Data Migration Tool可帮助将现有Magento1.x存储数据转移到Magento2.x。此命令行界面包括验证、进度跟踪、日志记录和测试功能。 有关安装说明，请参阅[安装数据迁移工具](https://experienceleague.adobe.com/docs/commerce-operations/tools/data-migration/basics/install.html)。 考虑浏览或参与[数据迁移存储库](https://github.com/magento/data-migration-tool)。
