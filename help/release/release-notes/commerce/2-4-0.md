...
* **删除Signifyd欺诈防护代码的核心集成**。 不再支持此核心功能。 商家应迁移到Commerce Marketplace上提供的[Signifyd Fraud &amp; Chargeback Protection扩展](https://marketplace.magento.com/signifyd-module-connect.html)。

* 已从代码库&#x200B;**中删除**&#x200B;核心Braintree模块。 Braintree Payments模块现在提供了相同的功能集。 请参阅[Braintree支付](https://marketplace.magento.com/paypal-module-braintree.html)。
...
此捆绑扩展取代了我们的核心Braintree集成，此集成已在此版本中移除。 请参阅[Braintree支付](https://marketplace.magento.com/paypal-module-braintree.html)。
...
* 不再支持重要欺诈防护的核心实施。 商家应迁移到Commerce Marketplace上提供的[Signifyd Fraud &amp; Chargeback Protection扩展](https://marketplace.magento.com/signifyd-module-connect.html)。
