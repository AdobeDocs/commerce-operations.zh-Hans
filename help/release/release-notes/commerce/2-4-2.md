...
Adobe Commerce 2.4.2不仅在性能和安全性方面进行了增强，而且在平台方面也进行了显着改进。 安全增强功能包括扩展对所有Cookie的`SameSite`属性的支持。 B2B改进侧重于支持采购订单的在线支付。 现在支持Elasticsearch7.9.x和Redis 6.x。

此版本包括对核心代码的280多项新修复和35项安全增强功能。 其中包括我们的社区成员解决近290个GitHub问题。 这些社区贡献的内容从小幅度的核心代码清理到GraphQL中的显着改进。

此版本中修复了2.4.1中标识的所有已知问题。

{{bics}}

## 应用`AC-3022.patch`以继续提供DHL作为装运承运人
...
在此版本中，将安装配置为使用拆分数据库的功能已被弃用。 当前使用拆分数据库的商家应该开始计划恢复或迁移到单个数据库，或者使用替代方法。 有关此问题的概述，请参阅Adobe Commerce](https://community.magento.com/t5/Magento-DevBlog/Deprecation-of-Split-Database-in-Magento-Commerce/ba-p/465187) DevBlog文章中的[弃用拆分数据库功能。  有关迁移说明，请参阅[从拆分数据库还原到单个数据库](../../../configuration/storage/revert-split-database.md)。
...
* 添加了对多个愿望清单的支持。 您可以使用GraphQL来[创建](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-wishlist.html)、[删除](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-wishlist.html)和[重命名](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-wishlist.html)愿望清单，以及在它们之间移动](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-products-between-wishlists.html)或[复制](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-products-between-wishlists.html)个项目。<!-- MC-32356-->[

* 增加了对退货授权(RMA)的支持。 购物者可以[申请退货](https://developer.adobe.com/commerce/webapi/graphql/mutations/request-return.html)。 如果商家接受请求，购物者可以执行任务，例如[添加评论](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-comment.html)和[添加跟踪信息](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-tracking.html)。<!-- MC-34596-->

* 添加了对以下B2B功能的支持：
   * 公司。 您可以添加公司[管理员](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company.html)、[用户](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-user.html)、[角色](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-role.html)和[团队](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-team.html)。<!-- MC-33861-->
   * 公司信用。 [公司查询](https://developer.adobe.com/commerce/webapi/graphql/queries/company.html)包含有关公司信用历史的详细信息。<!-- MC-33862-->
   * 申请列表。 您可以[创建](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-requisition-list.html)、[删除](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list.html)和[更新](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-requisition-list.html)申请列表。 支持还包括以下功能：在申购单列表中[添加](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-requisition-list.html)、[更新](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-products-in-wishlist.html)、[删除](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list-items.html)、[复制](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-items-between-requisition-lists.html)和[移动](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-items-between-requisition-lists.html)个项目，以及将申购单列表项目[添加到购物车](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-requisition-list-items-to-cart.html)。<!-- MC-34312-->

* 添加了对GraphQL中工会活动的支持。 [GitHub-29425](https://github.com/magento/magento2/issues/29425) <!-- ENGCOM-8291 -->

* 添加了对[比较列表](https://developer.adobe.com/commerce/webapi/graphql/queries/compare-list.html)的支持。 购物者可以[创建](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-compare-list.html)和[删除](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-compare-list.html)比较列表，以及将[添加](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-compare-list.html)和[删除](https://developer.adobe.com/commerce/webapi/graphql/mutations/remove-products-from-compare-list.html)项目至比较列表。 此外，以访客身份创建比较列表的购物者可以客户身份登录，并[保留](https://developer.adobe.com/commerce/webapi/graphql/mutations/assign-compare-list-to-customer.html)其比较列表。

* 添加了[`generateCustomerTokenAsAdmin`](https://developer.adobe.com/commerce/webapi/graphql/mutations/generate-customer-token-as-admin.html)突变并更新了`Customer`对象以支持远程购买帮助。
...
* 已将`staging`属性添加到[`ProductInterface`](https://developer.adobe.com/commerce/webapi/graphql/interfaces/product-interface.html)和[`CategoryInterface`](https://developer.adobe.com/commerce/webapi/graphql/interfaces/category-interface.html)，以确定产品是否已暂存，并查看其关联的促销活动信息。<!-- MC-33897-->
...
**现在可以使用在线付款方式完成采购订单**。 在初始结帐期间，系统会提示B2B购买者为每个[采购订单](https://experienceleague.adobe.com/en/docs/commerce-admin/b2b/purchase-orders/purchase-order-flow)选择其首选付款方式。 在采购订单获得批准后，系统将提示采购员输入付款详细信息，以将采购订单转换为最终订单。
...
* 页面生成器不再要求将所有内容类型都放在行中。 [页面生成器舞台](https://experienceleague.adobe.com/en/docs/commerce-admin/page-builder/walkthrough/3-catalog-content#stage)最初为空，并支持将以下内容类型直接添加到舞台：行、列、选项卡、HTML代码、块、动态块。

* 内容类型不再需要预定义的边距和填充。

* 通过新的移动设备[视口切换器](https://experienceleague.adobe.com/en/docs/commerce-admin/page-builder/walkthrough/3-catalog-content#viewports)和表单字段值的视口范围，用户和开发人员可以执行以下操作：

   * 创作时在不同的查看端口上查看内容。

   * 针对每个视区的不同内容类型优化最小高度字段参数。 (仅支持一个参数（最小高度）。 需要自定义开发，才能针对其他内容参数启用移动优化。)

   * 将字段范围添加到自定义字段和字段组（开发人员）。

### 交互式产品内指导

交互式产品内指南从管理员内向商家提供有关新功能公告、演练指南、入门信息和工具提示的使用提示和信息。  **如果未启用此功能，管理员必须选择加入管理员才能接收产品内指导**。 请参阅[使用情况数据收集](https://experienceleague.adobe.com/en/docs/commerce-admin/start/admin/admin)和[管理员使用情况](https://experienceleague.adobe.com/en/docs/commerce-admin/config/advanced/admin#admin-usage)。
...
**媒体集的新角色资源**。 此版本允许商家将管理员访问权限限制为仅可访问媒体集，并控制谁可执行这些操作：
...
MCOM连接器与2.4.2完全兼容。有关连接器的错误修复和增强功能，请参阅[连接器发行说明](https://omsdocs.magento.com/release-notes/connector/index.html)。 此版本包括对OMS命令行界面的改进，现在可提供合作伙伴和支持团队可用于对`retry`、`queue_prune`、`order_sync`、`message process`和`catalog export`进程进行故障排除的详细信息。

### 供应商开发的扩展

有关此版本功能和更改的更新，请参阅以下文章：

* [Amazon支付](https://marketplace.magento.com/amzn-amazon-pay-magento-2-module.html)。 Amazon Pay在此版本中已弃用，将在Magento2.5.0中删除。版本2.4.3及更高版本将仅包含兼容性更新和主要错误的修复。
...
* 在此版本中，将安装配置为使用拆分数据库的功能已被弃用。 请参阅Adobe Commerce](https://community.magento.com/t5/Magento-DevBlog/Deprecation-of-Split-Database-in-Magento-Commerce/ba-p/465187) DevBlog文章中的[弃用拆分数据库功能。
...
* 执行`bin/magento/setup:upgrade`后，`block_html`、`full_page`和`layout`缓存现在已按预期禁用。 [GitHub-28186](https://github.com/magento/magento2/issues/28186)
...
* 您现在可以在安装示例数据后执行`bin/magento/setup:upgrade`。 以前，当您尝试执行`bin/magento/setup:upgrade`时，应用程序显示此错误： `unable to apply data patch magento\catalogrulesampledata\setup\patch\data\installcatalogrulesampledata for module magento_catalogrulesampledata`。 应用程序还在系统日志中显示此错误： `main.ERROR: Sample Data error: Unable to unserialize value. Error: Syntax error`。 [GitHub-30685](https://github.com/magento/magento2/issues/30685)
...
* 对于具有受限权限的管理员，**商店** > **属性** > **评分**&#x200B;页面上的&#x200B;**添加新评分**&#x200B;按钮以及&#x200B;**保存**、**删除**、**重置**&#x200B;按钮不再可用。
...
* 安装Adobe Commerce后，当您尝试使用`ssh`容器更改`backend-frontname`时，应用程序不再引发错误。 [GitHub-26762](https://github.com/magento/magento2/issues/26762)
...
* 现在，在使用多种发运方法时，购物者可以使用“使用多个地址结帐”成功完成订单。 以前，应用程序显示以下错误： `There has been an error processing your request`。 [GitHub-30197](https://github.com/magento/magento2/issues/30197)
...
* 店面的产品排序问题已得到解决。 以前，当应用程序索引产品价格时，它偶尔会在`catalog_product_index_price`表中将可配置产品的`min_price`和`max_price`设置为0，这会影响店面的价格排序顺序。

<!-- MC-35608-->

* 应用程序现在已成功更新标记为`Product Type`的属性。 以前，由于在代码中保留了`product_type`属性，因此，当您尝试更新`Product Type`属性时，应用程序会显示此消息： `An attribute with the same code (product_type) already exists.`

<!-- MC-36214-->

* 保存产品后，应用程序不会再更改已上传视频在产品详细信息页面的图像和视频部分中的位置。 以前，为新图像位置分配一个索引值（列表中的位置），如果现有图像位置与其索引值不一致，则新图像会错误地放置在列表中。
...
* 通过REST API更新类别不会再禁用“启用类别”、“包含在菜单中”和“URL密钥”属性上的&#x200B;**使用默认值**&#x200B;设置。

<!-- MC-36832-->

* 如果管理员启用类别权限，则在重复访问类别页面时，不会再导致在完全页面缓存中缓存类别页面失败。 以前，对页面的后续访问无法从缓存中按预期提供，性能会降低。
...
* 应用程序现在已成功重新创建图像，并且每当商家使用POST`rest/all/V1/products`发送媒体集数据时，这些图像都会按预期在管理员中可见。 以前，如果图像在`pub/media`中被删除，但是介质中的记录仍然包含这些图像的记录，当商家通过POST`rest/all/V1/products`发送介质集数据时，应用程序会重新创建这些图像，但是删除了这些图像。 因此，商家只能看到“管理员”中的占位符，因为图像是在更新过程中创建和删除的。

<!-- MC-36903-->

* 现在，当您从网站取消分配项目时，记录会按预期删除。 以前，执行POST`rest/all/V1/products`时复制图像。

<!-- MC-38413-->

* 现在，`/V1/categories/{categoryId}/products`调用会按预期返回属于父类别的所有产品的列表。 以前，如果某个产品属于父类别的多个子类别，则应用程序会引发此类错误： `Internal Error. Details are available in the application log file. Report ID: webapi-5f8579e37db54`。  [GitHub-30461](https://github.com/magento/magento2/issues/30461)
...
* 应用程序现在正确显示多行自定义客户属性值。 以前，并非所有数据都会显示。
...
* 自定义地址属性现在可以在“我的帐户”区域和“管理员订单详细信息”页面中正确显示。

<!-- MC-37101-->

* 现在，当`Input Type`设置为`Text`且`Input Validation`设置为`Numeric Only`时，您可以在自定义客户属性中删除前导零。

<!-- MC-36721-->

* 该应用程序现在可以成功导出包含自定义性别属性值的客户数据。

<!-- MC-34650-->

* 现在，应用程序会按预期保存 B2B 用户的自定义客户属性值。 以前，为添加或编辑公司用户创建的自定义客户属性未与“添加新用户”窗体绑定，因此不会保存属性值。 此外，自定义日期属性作为字符串从数据库派生，未转换为店面显示的正确日期格式。
...
* 现在，在启用了&#x200B;**“启用自动分配给客户组”**&#x200B;的商店中，当购物者针对非默认客户组下达订单时，应用产品会将购物者分配给正确的客户组。 [GitHub-26976](https://github.com/magento/magento2/issues/26976)

<!-- MC-39783-->

* 当索引设置为&#x200B;**按计划更新**&#x200B;时，在多站点部署中删除非默认网站时，管理客户网格现在可按预期使用。 以前，应用程序不显示网格并引发此错误： `[2020-12-09 11:31:54] report.CRITICAL: The website with id 2 that was requested wasn't found. Verify the website and try again. \{"exception":"[object] (Magento\\Framework\\Exception\\NoSuchEntityException(code: 0): The website with id 2 that was requested wasn't found. Verify the website and try again. at /var/www/html/magento24ee/vendor/magento/module-store/Model/WebsiteRepository.php:110)"}`
...
* 商店主页上的图像现在可以成功渲染。 以前，页面源HTML已损坏，因为图像的base64代码中的三个连续斜杠被错误解释为注释。

<!-- MC-37369-->

* 现在，在使用阿拉伯语区域设置(`ar_SA - Saudi Arabia`)的商店中“管理员订单”列表筛选订单时，DatePicker可正常工作。
...
* 更改商店视图时，应用程序不再将客户重定向到主页。 现在，只有在第二个商店视图中找不到`$urlPath`时，`\Magento\VersionsCmsUrlRewrite\Model\StoreSwitcher::switch()`方法才会将购物者重定向到主页。
...
* 在不包含`0`元素的哈希数组上，`MessageValidator`不再失败。 [GitHub-30563](https://github.com/magento/magento2/issues/30563)

<!-- ENGCOM-8370 -->

* 已通过从`messages`、`authentication`、`progressBar`、`estimation`和`sidebar checkout`组件中删除`sortOrder`来增强`checkout_index_index.xml`文件中的代码。 [GitHub-30550](https://github.com/magento/magento2/issues/30550)

<!-- ENGCOM-8379 -->

* `calc`中的内容现已转义，这将在CSS输出文件中产生正确的`calc`值。 以前，应用程序返回不正确的`calc`值。 [GitHub-30542](https://github.com/magento/magento2/issues/30542)
...
* 的 `req.http.host/client.ip` 冗余散列已被删除，散列由清漆内置 VCL 处理。 [GitHub-29988](https://github.com/magento/magento2/issues/29988)

<!-- ENGCOM-8302 -->

* 添加了对文件上传程序的 `Magento_Ui`失败回调。 [GitHub-29557](https://github.com/magento/magento2/issues/29557)

<!-- ENGCOM-8405 -->

* 已更正启用`Magento_LoginAsCustomerAssistance`但禁用`Magento_LoginAsCustomerAdminUi`或`Magento_LoginAsCustomerLog`时发生的`acl.xml`不一致。 以前，当具有这些凭据的管理员尝试登录到管理员时，应用程序显示空白页面，并在出现以下情况时引发此错误： `Exception #0 (LogicException): Could not create an acl object: Invalid Document Element 'resource': The attribute 'title' is required but missing. Line: 13`。 [GitHub-30680](https://github.com/magento/magento2/issues/30680)
...
* 应用程序现在可以正确处理异步批量操作的消息传递和日志记录。 以前，尽管产品已更新，但`magento_operation`和`queue_message_status`表未正确更新，并且系统消息不正确。 [GitHub-29718](https://github.com/magento/magento2/issues/29718)

<!-- ENGCOM-8388 -->

* 现在，当购物者为商店启用“需要电子邮件确认&#x200B;**”时**，单击“重置密码”电子邮件中的“设置新密码&#x200B;**”**&#x200B;页面时，购物者将按预期重定向到“设置新密码”页面。以前，购物者被重定向回 **登录页面上的“忘记密码** ”按钮。 [GitHub-27954](https://github.com/magento/magento2/issues/27954)
...
* `products`查询现在会按预期返回层价格值。 [GitHub-29168](https://github.com/magento/magento2/issues/29168)
...
* 已从CMS模块中删除对`fileinfo`扩展的依赖项。 以前，当您尝试使用图像上传器上传图像时，应用程序会引发错误，当您在添加内容时单击&#x200B;**插入图像**&#x200B;按钮时会启动图像上传器。 [GitHub-24332](https://github.com/magento/magento2/issues/24332)，[GitHub-16531](https://github.com/magento/magento2/issues/16531)，[GitHub-29852](https://github.com/magento/magento2/issues/29852)
...
* 当导入的产品在CSV文件中将`qty`设置为0但`is_in_stock set`设置为1时，产品不会列在类别页面上，并且产品详细信息页面将其标识为库存不足。 以前，导入后，具有这些值的产品在店面中可见。
...
* 部分重新索引系统和完全重新索引系统之间的不一致已得到纠正。 现在，两个索引系统都使用相同的代码，这样可以正常工作。 以前，两个索引系统对共享索引器使用不同的逻辑，这可能导致索引器在每次运行部分重新索引系统之后失效。 [GitHub-29478](https://github.com/magento/magento2/issues/29478)，[GitHub-29297](https://github.com/magento/magento2/issues/29297)

<!-- MC-38168-->

* 我们解决了手动索引器导致类别页清空或类别页产品计数减少的问题。 以下情况出现类别页不完整或产品计数问题：
...
* 该 `SELECT entity_id IN` 语句在实现 MariaDB v.10.3.18 的部署中得到了改进，它提高了目录类别索引的性能。 [GitHub-25199](https://github.com/magento/magento2/issues/25199)

<!-- ENGCOM-8237 -->

* Adobe Commerce 通过消除每个索引器实例多次刷新标签的情况，提高了缓存性能。 [GitHub-29890](https://github.com/magento/magento2/issues/29890)
...
* 现在，当从媒体库插入格式副本时，图像上传器会显示正确的图像大小。 [GitHub-1806](https://github.com/magento/adobe-stock-integration/issues/1806)
...
* 启用&#x200B;**自动分配给客户组**&#x200B;后，来宾购物者现在可以下单PayPal。 付款在PayPal网关上处理，订单在Magento中创建，购物者看到订单感谢页面。 以前，订单已在PayPal网关上成功处理，但订单未在Adobe Commerce中创建。 购物者被重定向到订单审核页面，应用程序在该页面中显示以下错误： `Failed address validation: %1" error`。 [GitHub-25399](https://github.com/magento/magento2/issues/25399)
...
* `module-catalog-import-export/Model/Import/Product/Option.php`中的性能问题已得到解决。 导出或导入100,000多条记录所需的时间已缩短。 查看大量产品选项](https://support.magento.com/hc/en-us/articles/360050695772)知识库文章的[导入/导出时间比预期长。
...
* 已重构`Magento\Framework\DB\Adapter\Pdo\Mysql->isTableExists`以提高性能。 减少对`SHOW TABLE STATUS`的冗余调用，以检查表是否存在。 [GitHub-29662](https://github.com/magento/magento2/issues/29662)
...
* 现在，当部分订单完成时，可按预期计算应纳税订单的奖励积分。

<!-- MC-37244-->

* 商家现在可以成功对使用奖励点购买的订单发放部分退款，并且之后仍然可以退还剩余的订单。 以前，商家无法退还剩余订单的奖励积分。
...
* `sales_shipment_grid`的`order_created_at`列现在在每次更新后按预期更新。
...
* 现在，销售电子邮件异步发送功能只会针对在上次更新日期之后创建的那些订单发送电子邮件。 以前，启用异步发送时，应用程序不按日期过滤电子邮件。
...
* 当购物者更改装运方法时，将不再应用已基于装运方法应用的优惠券代码。 以前，当购物者切换运送方式时，该应用不会清除优惠券代码。

<!-- MC-34649-->

* 购物者应用优惠券代码的频率不能超过&#x200B;**每位客户的使用次数**&#x200B;设置允许的频率。 以前，如果购物者打开了多个浏览器窗口，同时下了多个订单，则每个订单都会收到折扣，即使&#x200B;**每位客户的使用次数**&#x200B;设置的值为&#x200B;**1**。
...
* 目录搜索的性能已得到改进。 禁用&#x200B;**启用搜索建议** （**存储** > **配置** > **目录** > **目录搜索** ）按预期工作。 以前，应用程序查询MySQL `search_query`表而不是Elasticsearch自动完成搜索建议。 [GitHub-25534](https://github.com/magento/magento2/issues/25534)

<!-- MC-35256-->

* Elasticsearch现在过滤产品价格的方式与MySQL相同。 在Elasticsearch索引中，字段类型`price_*`已从`float`更改为`double`，以提高精度并更正浮点错误。

<!-- ENGCOM-8393 -->

* 向管理员添加了键盘减号事件侦听器，以便在输入正斜线时激活全局搜索表单。 [GitHub-29551](https://github.com/magento/magento2/issues/29551)
...
* 现在，配置FPT后，结帐期间可以保存要发运至多个地址的订单。 之前，在完成多个地址的订单后，应用程序会显示空白页面，而不是订单成功页面。
...
* 增加了模块的 `AdminAnalytics` 测试覆盖率。 [GitHub-29500](https://github.com/magento/magento2/issues/29500)
...
* 包含 URL 的标头值现在可以在 k 中 `ApiFunctional TestFramewor`正确解析。 [GitHub-26425](https://github.com/magento/magento2/issues/26425)

<!-- ENGCOM-8382 -->

* `—no-tablespaces`已添加到`mysqldump`的所有匹配项，这允许在不具有`PROCESS`权限的情况下运行集成测试（自MySQL 5.7.31 / 8.0.21以来是默认运行`mysqldump`所必需的）。 [GitHub-30566](https://github.com/magento/magento2/issues/30566)

### 主题

<!-- ENGCOM-8419 -->

* 向`bin/magento setup:static-content:deploy`命令添加了新的`--no-parent`标志，该标志阻止编译主题的父级。 通过这个新标志，您可以避免不必要的编译，从而显着提高静态内容部署过程的性能。 请注意，使用`compact`策略时，此新标记不起作用。 [GitHub-30184](https://github.com/magento/magento2/issues/30184)
...
* 当管理员区域设置为阿拉伯语(`ar_SA - Saudi Arabia`)时，“管理员订单”网格日期选取器现在可按预期工作。

<!-- MC-38476 -->

* 当顾客在注册或添加新地址时输入具有有效邮递区号的阿根廷地址时，应用程序不再显示错误消息。 以前，应用程序显示以下错误： `Provided Zip/Postal Code seems to be invalid. Example: 1234. If you believe it is the right one you can ignore this notice.`

<!-- MC-38663-->

* 当购物者输入朝鲜地址的5位数邮政编码时，应用程序不再出现错误。
...
* 定义有限宽度的CSS类现在按预期应用于Admin **Store** > **配置** > **目录** > **XML站点地图** > **生成设置**&#x200B;上的&#x200B;**开始时间**&#x200B;字段。  [GitHub-29496](https://github.com/magento/magento2/issues/29496)
...
* 现在，优惠券代码文本字段在Internet Explorer/EDGE浏览器中显示为合适的宽度。
...
* 已将光标的位置从&#x200B;**我的帐户** > **礼品注册表** > **共享礼品注册表**&#x200B;上的&#x200B;**消息**&#x200B;字段的中间调整为开头。

<!-- MC-33497-->

* 解决了添加计划导出页面上的列布局显示问题。
...
* 现在，在店面创建帐户页面上，应用程序会按预期在&#x200B;**日期**&#x200B;输入字段旁边显示一个日历图标。

<!-- ENGCOM-8085 -->

* 已向`lib/web/css/source/lib/variables/_typography.less`添加字体粗细变量。 [GitHub-29778](https://github.com/magento/magento2/issues/29778)
...
* 当您使用POST`V1/order/:orderId/ship`创建部分装运时，终结点将返回正确数量的已装运产品。

<!-- MC-38425-->

* 使用POST`V1/order/:orderID/invoice`创建的发票现在可以准确地反映按商店贷记支付的部分款项。 以前，当使用商店信用支付部分订单的金额时，创建发票时不会考虑商店信用。
...
* 在提供`save_rewrites_history`自定义属性时，PUT`V1/categories/:id`端点现在存储为类别URL密钥创建301重定向所需的数据。 [GitHub-29174](https://github.com/magento/magento2/issues/29174)，[GitHub-30240](https://github.com/magento/magento2/issues/30240)
...
* 已为`\Magento\Wishlist\Controller\Shared\Allcart`实施`ActionInterface`。 [GitHub-29537](https://github.com/magento/magento2/issues/29537)
...
1. 在新目录(`magento_root/pub/shop01/index.php`)中创建一个`index.php`文件并添加此内容：
...
**问题**：在运行库存的多商店部署中，不能使用`addConfigurableProductToCart` GraphQL突变将可配置产品添加到非默认商店视图中的购物车。 （亮度店面不受影响。） 应用程序显示以下错误： `Could not add item to cart. Please check required options and try again`。 **解决方法**：改用`addProductsToCart`变异。 [GitHub-31660](https://github.com/magento/magento2/issues/31660)<!-- PWA-1298-->

**问题**：当购物者首次在付款页面的CAPTCHA字段中输入正确的代码时，应用程序未按预期提交付款信息，但显示以下错误： `There has been an error processing your request`。 仅当购物者尝试在不输入CAPTCHA代码或不正确输入订单的情况下下单时，才会发生这种情况。  **解决方法**：刷新页面。<!-- MC-40506-->

**问题**：当购物者单击&#x200B;**使用Venmo**&#x200B;支付时，应用程序会按预期在Braintree中创建订单，但不会在Admin中创建该订单。 **解决方法**：无。 请参阅[2.4.2已知问题：BraintreeVenmo付款不起作用](https://support.magento.com/hc/en-us/articles/360054662652/)知识库文章。 <!-- BUNDLE-2894-->
...
**问题**：禁用上下文模式&#x200B;**后** PayPal尝试使用快速结账从采购订单下订单时，买家将被重定向到购物车。<!-- B2B-1604-->

**问题**：当采购员创建采购订单，然后导航到结帐页时，应用程序有时显示404错误。 当采购员先前使用在线付款方法创建不同的采购订单而未完成之前的采购就浏览到结帐页面时，会发生此错误。 买方仍然可以下采购订单。 **解决方法**：无。<!-- B2B-1605-->

**问题**：在采购订单结账期间，即使买方在最终结账期间更改了付款方式，特定付款方式的折扣也会保留。 因此，客户可能会获得他们无权享有的折扣。 出现此情况的原因是，尽管付款方式发生了更改，但原来的付款方式仍应用购物车规则。 **解决方法**：无。 请参阅[2.4.2 B2B已知问题：更改付款方式后，在线采购订单仍存在折扣](https://support.magento.com/hc/en-us/articles/360054667312)知识库文章。<!-- B2B-1012 -->

**问题**： `deleteRequisitionListOutput`查询返回有关已删除的申请列表（而不是剩余的申请列表）的详细信息。<!-- MC-39894-->

## 社区贡献

我们感谢更广泛的Magento开源社区，并感谢他们对此版本的贡献。

社区工程团队 [Magento贡献者](https://magento.biterg.io/app/kibana) 按月，季度和年度维护顶级贡献个人和合作伙伴的列表。 从该参与者页面，您可以单击链接以转到GitHub上其合并的PR。
