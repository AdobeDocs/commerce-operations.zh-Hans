...
**问题**：从2.4.5之前的产品版本升级到Adobe Commerce 2.4.6或更高版本后，暂存销售规则标签可能不匹配。 **解决方法**：在升级期间在更新元数据步骤之前应用ACSD-50625_2.4.5-P1.patch。 请参阅从版本&lt; 2.4.5[&#128279;](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27186)升级时的salesRules标签问题。

解决此问题的常规步骤：

1. 下载所需的修补程序。 请参阅从版本&lt; 2.4.5[&#128279;](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27186)升级时的salesRules标签问题。
