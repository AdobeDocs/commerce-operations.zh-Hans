...
1. 云上受支持的安全版本的Adobe Commerce。 完全支持的版本包括2.4.8、2.4.9或最新发布的版本。 请参阅[生命周期策略](https://experienceleague.adobe.com/en/docs/commerce-operations/release/planning/lifecycle-policy)文档。
...
* **升级兼容性报告：** Adobe提供了一个详细的报告，该报告准确地识别了升级到Adobe Commerce版本2.4.9所需的内容，包括识别哪些模块和文件需要更新、严重问题的数量等。 有关如何生成升级兼容性报告的详细信息，请参阅[全站点分析工具](https://experienceleague.adobe.com/en/docs/commerce-operations/tools/site-wide-analysis-tool/access)文档。
