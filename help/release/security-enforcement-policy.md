...
Adobe提供了一些工具，可降低迁移到Adobe Commerce as a Cloud Service的成本和时间。 这是免费的。 这些工具仅适用于迁移；它们不用于Adobe Commerce on Cloud上的版本升级。 有关完整的迁移指南（包括迁移路径和阶段），请参阅[迁移概述](https://experienceleague.adobe.com/zh-hans/docs/commerce/cloud-service/migration/overview)。
