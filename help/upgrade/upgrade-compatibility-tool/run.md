...
请参阅此[视频教程](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/extensibility/backend-development/upgrade/upgrade-compatibility-tool-overview) (06:02)，了解有关[!DNL Upgrade Compatibility Tool]的更多信息。
...
有关详细信息，请参阅[部署vanilla实例](https://developer.adobe.com/commerce/contributor/guides/install/)主题。
