    ...
    <tr>
      <td><strong>发行说明和公告</strong>
        <p>了解Adobe Commerce的最新发展，包括产品策略、安全性、错误修复和已知问题。</p>
          <ul>
            ...
            <li><a href="https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/overview">Adobe帮助中心</a></li>
            ...
            <li><a href="https://experienceleague.adobe.com/docs/commerce-operations/release/notes/overview.html">Adobe Commerce on cloud或内部部署发行说明</a></li>
      ...
      <td><strong>工具</strong>
        <p>Browse工具旨在让您更轻松地查找和使用Adobe Commerce软件。</p>
          <ul>
            <li><a href="https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/extensibility/backend-development/upgrade/uct-phpstorm">升级兼容性工具PhpStorm插件</a>（视频）</li>
    ...
    <tr>
      <td><strong>日历和策略</strong>
        <p>查看有关Adobe Commerce版本和策略的详细信息。</p>
          <ul>
            <li><a href="https://experienceleague.adobe.com/en/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-eos-policy-faq">Adobe Commerce软件终止支持常见问题解答</a></li>
            ...
            <li><a href="https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/faq/adobe-commerce-release-strategy-lifecycle-policy">新Adobe Commerce发布策略、更新的生命周期策略和扩展支持的常见问题解答</a></li>
      ...
      <td><strong>升级资源</strong>
        <p>确保店面安全和高效运行。 通过查看Adobe Commerce丰富的技术文档，为Adobe升级做好准备。</p>
          <ul>
            ...
            <li><a href="https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/extensibility/backend-development/upgrade/2-4-upgrade-workshop">2.4技术升级讲习班录音</a></li>
            <li><a href="https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/cannot-access-the-latest-magento-commerce-pre-release">访问预发行版</a></li>
