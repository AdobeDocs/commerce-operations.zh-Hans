...
Commerce 2符合PSR-3标准。 默认情况下，Commerce使用[独白](https://github.com/Seldaek/monolog)。 在Commerce应用程序`Psr\Log\LoggerInterface`[`di.xml`中作为](https://github.com/magento/magento2/blob/2.4/app/etc/di.xml#L9)的首选项实现的单一日志。
