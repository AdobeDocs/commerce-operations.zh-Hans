...
从版本2.4.4开始，Adobe Commerce要求[Elasticsearch](https://www.elastic.co)或[OpenSearch](https://opensearch.org/docs/latest/opensearch/install/index/)作为目录搜索引擎。 2.4.x的先前版本要求使用Elasticsearch。 有关安装搜索引擎和初始配置的详细信息，请参阅以下主题：
