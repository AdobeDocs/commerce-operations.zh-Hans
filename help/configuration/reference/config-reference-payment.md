...
管理员中提供了这些配置值，位置如下： **商店** >设置> **配置** > **销售** > **支付方式**.
...
| 启用关联签出体验 | `payment/paypal_express/in_context` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 转移送货选项 | `payment/paypal_express/transfer_shipping_options` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 快捷键按钮风格 | `paypal/wpp/button_flavor` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 启用PayPal来宾结帐 | `payment/paypal_express/solution_type` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 一天中的时间 | `paypal/fetch_reports/time` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 子授权数量 | `payment/paypal_express/child_authorization_number` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_all_paypal/express_checkout/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
这些选项仅在您选择英国作为选项时可用 [商户所在国家/地区](../reference/config-reference-sens.md#payment-sensitive-and-system-specific-paths).
...
| 拒绝事务处理条件： | `payment_all_paypal/paypal_payflowpro/settings_paypal_payflow/settings_paypal_payflow_advanced/paypal_payflow_avs_check/heading_avs_settings` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 卡片安全代码不匹配 | `payment/payflowpro/avs_security_code` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_all_paypal/payflow_link/settings_payflow_link/settings_payflow_link_advanced/payflow_link_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
>[!INFO]
>
>可用的路径由您选择的路径决定 [商家所在国家/地区](../reference/config-reference-sens.md#payment-sensitive-and-system-specific-paths).
...
| PayPal商户页面样式 | `payment_nz/express_checkout_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_nz/paypal_group_all_in_one/wps_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 拒绝事务处理条件： | `payment_nz/paypal_payment_gateways/paypal_payflowpro_nz/settings_paypal_payflow/settings_paypal_payflow_advanced/paypal_payflow_avs_check/heading_avs_settings` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 将支票发送至 | `payment_nz/checkmo/mailing_address` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用 | `payment_nz/cybersource/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_nz/cybersource/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_nz/cybersource/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 新订单状态 | `payment_nz/cybersource/order_status` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_nz/cybersource/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_nz/cybersource/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_nz/cybersource/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_nz/cybersource/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最小订单总计 | `payment_nz/cybersource/min_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最大订单总计 | `payment_nz/cybersource/max_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_nz/cybersource/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_nz/worldpay/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_nz/worldpay/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 允许编辑联系人信息 | `payment_nz/worldpay/fix_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 隐藏联系人信息 | `payment_nz/worldpay/hide_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 签名字段 | `payment_nz/worldpay/signature_fields` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_nz/worldpay/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 测试的付款操作 | `payment_nz/worldpay/test_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_nz/worldpay/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_nz/worldpay/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_nz/worldpay/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将订单状态设置为CVV疑似欺诈 | `payment_nz/worldpay/cvv_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将邮政编码AVS的订单状态设置为可疑欺诈 | `payment_nz/worldpay/avs_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_nz/worldpay/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_nz/eway/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 连接类型 | `payment_nz/eway/connection_type` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_nz/eway/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_nz/eway/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_nz/eway/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_nz/eway/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_nz/eway/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_nz/eway/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_nz/eway/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| PayPal商户页面样式 | `payment_hk/express_checkout_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_hk/paypal_group_all_in_one/wps_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用 | `payment_hk/cybersource/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_hk/cybersource/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_hk/cybersource/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 新订单状态 | `payment_hk/cybersource/order_status` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_hk/cybersource/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_hk/cybersource/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_hk/cybersource/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_hk/cybersource/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最小订单总计 | `payment_hk/cybersource/min_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最大订单总计 | `payment_hk/cybersource/max_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_hk/cybersource/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_hk/worldpay/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_hk/worldpay/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 允许编辑联系人信息 | `payment_hk/worldpay/fix_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 隐藏联系人信息 | `payment_hk/worldpay/hide_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_hk/worldpay/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 测试的付款操作 | `payment_hk/worldpay/test_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_hk/worldpay/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_hk/worldpay/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_hk/worldpay/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将订单状态设置为CVV疑似欺诈 | `payment_hk/worldpay/cvv_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将邮政编码AVS的订单状态设置为可疑欺诈 | `payment_hk/worldpay/avs_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_hk/worldpay/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_hk/eway/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 连接类型 | `payment_hk/eway/connection_type` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_hk/eway/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 沙盒模式 | `payment_hk/eway/sandbox_flag` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_hk/eway/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_hk/eway/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_hk/eway/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_hk/eway/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_hk/eway/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_hk/eway/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| PayPal商户页面样式 | `payment_es/express_checkout_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_es/paypal_group_all_in_one/wps_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用 | `payment_es/cybersource/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_es/cybersource/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_es/cybersource/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 配置文件ID | `payment_es/cybersource/profile_id` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) | ![已加密](/help/assets/configuration/cloud-enc.png) |
| 新订单状态 | `payment_es/cybersource/order_status` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_es/cybersource/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_es/cybersource/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_es/cybersource/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_es/cybersource/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最小订单总计 | `payment_es/cybersource/min_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最大订单总计 | `payment_es/cybersource/max_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_es/cybersource/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_es/worldpay/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_es/worldpay/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 安装Id | `payment_es/worldpay/installation_id` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 远程管理员安装ID | `payment_es/worldpay/admin_installation_id` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 允许编辑联系人信息 | `payment_es/worldpay/fix_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 隐藏联系人信息 | `payment_es/worldpay/hide_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 签名字段 | `payment_es/worldpay/signature_fields` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 测试模式 | `payment_es/worldpay/sandbox_flag` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 测试的付款操作 | `payment_es/worldpay/test_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_es/worldpay/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_es/worldpay/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_es/worldpay/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将订单状态设置为CVV疑似欺诈 | `payment_es/worldpay/cvv_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将邮政编码AVS的订单状态设置为可疑欺诈 | `payment_es/worldpay/avs_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_es/worldpay/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_es/eway/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 连接类型 | `payment_es/eway/connection_type` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_es/eway/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_es/eway/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_es/eway/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_es/eway/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_es/eway/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_es/eway/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_es/eway/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| PayPal商户页面样式 | `payment_it/express_checkout_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_it/paypal_group_all_in_one/wps_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用 | `payment_it/cybersource/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_it/cybersource/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_it/cybersource/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 新订单状态 | `payment_it/cybersource/order_status` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_it/cybersource/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_it/cybersource/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_it/cybersource/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_it/cybersource/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最小订单总计 | `payment_it/cybersource/min_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最大订单总计 | `payment_it/cybersource/max_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_it/cybersource/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_it/worldpay/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_it/worldpay/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 允许编辑联系人信息 | `payment_it/worldpay/fix_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 隐藏联系人信息 | `payment_it/worldpay/hide_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 签名字段 | `payment_it/worldpay/signature_fields` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_it/worldpay/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 测试的付款操作 | `payment_it/worldpay/test_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_it/worldpay/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_it/worldpay/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_it/worldpay/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将订单状态设置为CVV疑似欺诈 | `payment_it/worldpay/cvv_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将邮政编码AVS的订单状态设置为可疑欺诈 | `payment_it/worldpay/avs_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_it/worldpay/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_it/eway/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 连接类型 | `payment_it/eway/connection_type` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_it/eway/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_it/eway/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_it/eway/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_it/eway/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_it/eway/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_it/eway/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_it/eway/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| PayPal商户页面样式 | `payment_fr/express_checkout_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_fr/paypal_group_all_in_one/wps_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用 | `payment_fr/cybersource/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_fr/cybersource/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_fr/cybersource/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 新订单状态 | `payment_fr/cybersource/order_status` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_fr/cybersource/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_fr/cybersource/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_fr/cybersource/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_fr/cybersource/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最小订单总计 | `payment_fr/cybersource/min_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最大订单总计 | `payment_fr/cybersource/max_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_fr/cybersource/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_fr/worldpay/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_fr/worldpay/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 允许编辑联系人信息 | `payment_fr/worldpay/fix_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 隐藏联系人信息 | `payment_fr/worldpay/hide_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_fr/worldpay/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 测试的付款操作 | `payment_fr/worldpay/test_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_fr/worldpay/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_fr/worldpay/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_fr/worldpay/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将订单状态设置为CVV疑似欺诈 | `payment_fr/worldpay/cvv_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将邮政编码AVS的订单状态设置为可疑欺诈 | `payment_fr/worldpay/avs_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_fr/worldpay/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_fr/eway/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 连接类型 | `payment_fr/eway/connection_type` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_fr/eway/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_fr/eway/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_fr/eway/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_fr/eway/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_fr/eway/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_fr/eway/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_fr/eway/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| PayPal商户页面样式 | `payment_jp/express_checkout_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_jp/paypal_group_all_in_one/wps_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用 | `payment_jp/cybersource/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_jp/cybersource/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_jp/cybersource/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_jp/cybersource/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_jp/cybersource/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_jp/cybersource/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_jp/cybersource/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最小订单总计 | `payment_jp/cybersource/min_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最大订单总计 | `payment_jp/cybersource/max_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_jp/cybersource/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_jp/worldpay/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_jp/worldpay/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 允许编辑联系人信息 | `payment_jp/worldpay/fix_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 隐藏联系人信息 | `payment_jp/worldpay/hide_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_jp/worldpay/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 测试的付款操作 | `payment_jp/worldpay/test_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_jp/worldpay/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_jp/worldpay/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_jp/worldpay/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将订单状态设置为CVV疑似欺诈 | `payment_jp/worldpay/cvv_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将邮政编码AVS的订单状态设置为可疑欺诈 | `payment_jp/worldpay/avs_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_jp/worldpay/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_jp/eway/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 连接类型 | `payment_jp/eway/connection_type` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_jp/eway/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_jp/eway/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_jp/eway/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_jp/eway/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_jp/eway/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_jp/eway/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_jp/eway/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| PayPal商户页面样式 | `payment_au/express_checkout_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_au/paypal_group_all_in_one/wps_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 拒绝事务处理条件： | `payment_au/paypal_payment_gateways/paypal_payflowpro_au/settings_paypal_payflow/settings_paypal_payflow_advanced/paypal_payflow_avs_check/heading_avs_settings` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 将支票发送至 | `payment_au/checkmo/mailing_address` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用 | `payment_au/cybersource/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_au/cybersource/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_au/cybersource/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| 配置文件ID | `payment_au/cybersource/profile_id` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) | ![已加密](/help/assets/configuration/cloud-enc.png) |
| 新订单状态 | `payment_au/cybersource/order_status` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_au/cybersource/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_au/cybersource/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_au/cybersource/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_au/cybersource/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最小订单总计 | `payment_au/cybersource/min_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最大订单总计 | `payment_au/cybersource/max_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_au/cybersource/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_au/worldpay/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_au/worldpay/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 安装Id | `payment_au/worldpay/installation_id` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 允许编辑联系人信息 | `payment_au/worldpay/fix_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 隐藏联系人信息 | `payment_au/worldpay/hide_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 签名字段 | `payment_au/worldpay/signature_fields` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_au/worldpay/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 测试模式 | `payment_au/worldpay/sandbox_flag` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 测试的付款操作 | `payment_au/worldpay/test_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_au/worldpay/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_au/worldpay/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_au/worldpay/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将订单状态设置为CVV疑似欺诈 | `payment_au/worldpay/cvv_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将邮政编码AVS的订单状态设置为可疑欺诈 | `payment_au/worldpay/avs_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_au/worldpay/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_au/eway/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 连接类型 | `payment_au/eway/connection_type` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_au/eway/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_au/eway/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_au/eway/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_au/eway/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_au/eway/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_au/eway/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_au/eway/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| PayPal商户页面样式 | `payment_ca/express_checkout_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_ca/paypal_group_all_in_one/wps_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 拒绝事务处理条件： | `payment_ca/paypal_payment_gateways/wpp_ca/settings_paypal_payflow/settings_paypal_payflow_advanced/paypal_payflow_avs_check/heading_avs_settings` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 拒绝事务处理条件： | `payment_ca/paypal_payment_gateways/paypal_payflowpro_ca/settings_paypal_payflow/settings_paypal_payflow_advanced/paypal_payflow_avs_check/heading_avs_settings` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_ca/paypal_payment_gateways/payflow_link_ca/settings_payflow_link/settings_payflow_link_advanced/payflow_link_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用 | `payment_ca/cybersource/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_ca/cybersource/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_ca/cybersource/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_ca/cybersource/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_ca/cybersource/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_ca/cybersource/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_ca/cybersource/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最小订单总计 | `payment_ca/cybersource/min_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最大订单总计 | `payment_ca/cybersource/max_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_ca/cybersource/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_ca/worldpay/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_ca/worldpay/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 允许编辑联系人信息 | `payment_ca/worldpay/fix_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 隐藏联系人信息 | `payment_ca/worldpay/hide_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 签名字段 | `payment_ca/worldpay/signature_fields` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_ca/worldpay/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 测试的付款操作 | `payment_ca/worldpay/test_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_ca/worldpay/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_ca/worldpay/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_ca/worldpay/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将订单状态设置为CVV疑似欺诈 | `payment_ca/worldpay/cvv_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将邮政编码AVS的订单状态设置为可疑欺诈 | `payment_ca/worldpay/avs_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_ca/worldpay/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_ca/eway/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 连接类型 | `payment_ca/eway/connection_type` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_ca/eway/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_ca/eway/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_ca/eway/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_ca/eway/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_ca/eway/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_ca/eway/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_ca/eway/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| PayPal商户页面样式 | `payment_other/express_checkout_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_other/paypal_group_all_in_one/wps_other/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用 | `payment_other/cybersource/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_other/cybersource/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_other/cybersource/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_other/cybersource/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_other/cybersource/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_other/cybersource/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_other/cybersource/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最小订单总计 | `payment_other/cybersource/min_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最大订单总计 | `payment_other/cybersource/max_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_other/cybersource/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_other/worldpay/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_other/worldpay/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 允许编辑联系人信息 | `payment_other/worldpay/fix_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 隐藏联系人信息 | `payment_other/worldpay/hide_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 签名字段 | `payment_other/worldpay/signature_fields` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_other/worldpay/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 测试的付款操作 | `payment_other/worldpay/test_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_other/worldpay/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_other/worldpay/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_other/worldpay/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将订单状态设置为CVV疑似欺诈 | `payment_other/worldpay/cvv_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将邮政编码AVS的订单状态设置为可疑欺诈 | `payment_other/worldpay/avs_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_other/worldpay/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_other/eway/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 连接类型 | `payment_other/eway/connection_type` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_other/eway/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_other/eway/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_other/eway/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_other/eway/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_other/eway/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_other/eway/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_other/eway/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| PayPal商户页面样式 | `payment_de/paypal_payment_solutions/express_checkout_de/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用 | `payment_de/cybersource/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_de/cybersource/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_de/cybersource/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 新订单状态 | `payment_de/cybersource/order_status` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_de/cybersource/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_de/cybersource/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_de/cybersource/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_de/cybersource/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最小订单总计 | `payment_de/cybersource/min_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最大订单总计 | `payment_de/cybersource/max_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_de/cybersource/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| 已启用 | `payment_de/worldpay/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_de/worldpay/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 允许编辑联系人信息 | `payment_de/worldpay/fix_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 隐藏联系人信息 | `payment_de/worldpay/hide_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 签名字段 | `payment_de/worldpay/signature_fields` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 测试模式 | `payment_de/worldpay/sandbox_flag` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 测试的付款操作 | `payment_de/worldpay/test_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_de/worldpay/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_de/worldpay/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_de/worldpay/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将订单状态设置为CVV疑似欺诈 | `payment_de/worldpay/cvv_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将邮政编码AVS的订单状态设置为可疑欺诈 | `payment_de/worldpay/avs_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_de/worldpay/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_de/eway/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 连接类型 | `payment_de/eway/connection_type` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_de/eway/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_de/eway/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_de/eway/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_de/eway/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_de/eway/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_de/eway/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_de/eway/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| PayPal商户页面样式 | `payment_gb/paypal_alternative_payment_methods/express_checkout_gb/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_gb/paypal_group_all_in_one/payments_pro_hosted_solution_with_express_checkout/pphs_settings/pphs_settings_advanced/pphs_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_gb/paypal_group_all_in_one/wps_express/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用 | `payment_gb/cybersource/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_gb/cybersource/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_gb/cybersource/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 新订单状态 | `payment_gb/cybersource/order_status` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_gb/cybersource/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_gb/cybersource/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_gb/cybersource/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_gb/cybersource/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最小订单总计 | `payment_gb/cybersource/min_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最大订单总计 | `payment_gb/cybersource/max_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_gb/cybersource/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| 已启用 | `payment_gb/worldpay/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_gb/worldpay/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 交易的MD5密码 | `payment_gb/worldpay/md5_secret` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 允许编辑联系人信息 | `payment_gb/worldpay/fix_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 隐藏联系人信息 | `payment_gb/worldpay/hide_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 签名字段 | `payment_gb/worldpay/signature_fields` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_gb/worldpay/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 测试的付款操作 | `payment_gb/worldpay/test_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_gb/worldpay/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_gb/worldpay/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_gb/worldpay/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将订单状态设置为CVV疑似欺诈 | `payment_gb/worldpay/cvv_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将邮政编码AVS的订单状态设置为可疑欺诈 | `payment_gb/worldpay/avs_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_gb/worldpay/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_gb/eway/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 连接类型 | `payment_gb/eway/connection_type` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_gb/eway/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_gb/eway/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_gb/eway/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_gb/eway/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_gb/eway/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_gb/eway/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_gb/eway/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| PayPal商户页面样式 | `payment_us/paypal_alternative_payment_methods/express_checkout_us/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_us/paypal_group_all_in_one/payflow_advanced/settings_payments_advanced/settings_payments_advanced_advanced/frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 拒绝事务处理条件： | `payment_us/paypal_group_all_in_one/wpp_usuk/settings_paypal_payflow/settings_paypal_payflow_advanced/paypal_payflow_avs_check/heading_avs_settings` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_us/paypal_group_all_in_one/wpp_usuk/settings_paypal_payflow/settings_paypal_payflow_advanced/paypal_payflow_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_us/paypal_group_all_in_one/wps_express/settings_ec/settings_ec_advanced/express_checkout_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 拒绝事务处理条件： | `payment_us/paypal_payment_gateways/paypal_payflowpro_with_express_checkout/settings_paypal_payflow/settings_paypal_payflow_advanced/paypal_payflow_avs_check/heading_avs_settings` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_us/paypal_payment_gateways/paypal_payflowpro_with_express_checkout/settings_paypal_payflow/settings_paypal_payflow_advanced/paypal_payflow_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| PayPal商户页面样式 | `payment_us/paypal_payment_gateways/payflow_link_us/settings_payflow_link/settings_payflow_link_advanced/payflow_link_frontend/paypal_pages` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用 | `payment_us/cybersource/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_us/cybersource/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_us/cybersource/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 新订单状态 | `payment_us/cybersource/order_status` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_us/cybersource/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_us/cybersource/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_us/cybersource/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_us/cybersource/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最小订单总计 | `payment_us/cybersource/min_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 最大订单总计 | `payment_us/cybersource/max_order_total` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_us/cybersource/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_us/worldpay/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_us/worldpay/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 允许编辑联系人信息 | `payment_us/worldpay/fix_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 隐藏联系人信息 | `payment_us/worldpay/hide_contact` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 签名字段 | `payment_us/worldpay/signature_fields` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_us/worldpay/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 测试的付款操作 | `payment_us/worldpay/test_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_us/worldpay/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_us/worldpay/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_us/worldpay/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将订单状态设置为CVV疑似欺诈 | `payment_us/worldpay/cvv_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 将邮政编码AVS的订单状态设置为可疑欺诈 | `payment_us/worldpay/avs_fraud_case` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 排序顺序 | `payment_us/worldpay/sort_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `payment_us/eway/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 连接类型 | `payment_us/eway/connection_type` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 标题 | `payment_us/eway/title` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 付款操作 | `payment_us/eway/payment_action` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 调试 | `payment_us/eway/debug` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 信用卡类型 | `payment_us/eway/cctypes` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自适用国家/地区的付款 | `payment_us/eway/allowspecific` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来自特定国家/地区的付款 | `payment_us/eway/specificcountry` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
