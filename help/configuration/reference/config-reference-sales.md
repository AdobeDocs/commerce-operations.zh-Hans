...
| 礼品卡 | `sales/totals_sort/giftcardaccount` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 商店点数 | `sales/totals_sort/customerbalance` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| 包括税额目标 | `sales/minimum_order/tax_including` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 描述消息 | `sales/minimum_order/description` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 要在购物车中显示的错误 | `sales/minimum_order/error_message` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 允许订单物料的礼品消息 | `sales/gift_options/allow_items` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 允许订单级别的礼品包装 | `sales/gift_options/wrapping_allow_order` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 允许订单物料的礼品包装 | `sales/gift_options/wrapping_allow_items` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 允许礼品收据 | `sales/gift_options/allow_gift_receipt` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 允许打印卡 | `sales/gift_options/allow_printed_card` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 打印卡的默认价格 | `sales/gift_options/printed_card_price` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| 在Storefront的“我的帐户”上启用“按SKU排序” | `sales/product_sku/my_account_enable` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| 客户组 | `sales/product_sku/allowed_groups` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 启用存档 | `sales/magento_salesarchive/active` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 存档已购订单 | `sales/magento_salesarchive/age` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 要存档的订单状态 | `sales/magento_salesarchive/order_statuses` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 在店面启用RMA | `sales/magento_rma/enabled` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 在产品级别启用RMA | `sales/magento_rma/enabled_on_product` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| 贷项通知单注释电子邮件发件人 | `sales_email/creditmemo_comment/identity` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 贷项通知单备注电子邮件模板 | `sales_email/creditmemo_comment/template` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 来宾的贷项通知单备注电子邮件模板 | `sales_email/creditmemo_comment/guest_template` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 发送贷项通知单备注电子邮件复制方法 | `sales_email/creditmemo_comment/copy_method` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 已启用 | `sales_email/magento_rma/enabled` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| RMA电子邮件发件人 | `sales_email/magento_rma/identity` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| RMA电子邮件模板 | `sales_email/magento_rma/template` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来宾的RMA电子邮件模板 | `sales_email/magento_rma/guest_template` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 发送RMA电子邮件复制方法 | `sales_email/magento_rma/copy_method` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `sales_email/magento_rma_auth/enabled` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| RMA授权电子邮件发件人 | `sales_email/magento_rma_auth/identity` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| rma授权电子邮件模板 | `sales_email/magento_rma_auth/template` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来宾的RMA授权电子邮件模板 | `sales_email/magento_rma_auth/guest_template` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 发送RMA授权电子邮件复制方法 | `sales_email/magento_rma_auth/copy_method` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `sales_email/magento_rma_comment/enabled` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| RMA注释电子邮件发件人 | `sales_email/magento_rma_comment/identity` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| RMA备注电子邮件模板 | `sales_email/magento_rma_comment/template` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 来宾的RMA评论电子邮件模板 | `sales_email/magento_rma_comment/guest_template` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 发送RMA电子邮件复制方法 | `sales_email/magento_rma_comment/copy_method` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 已启用 | `sales_email/magento_rma_customer_comment/enabled` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| RMA注释电子邮件发件人 | `sales_email/magento_rma_customer_comment/identity` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| RMA注释电子邮件收件人 | `sales_email/magento_rma_customer_comment/recipient` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| RMA备注电子邮件模板 | `sales_email/magento_rma_customer_comment/template` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 发送RMA电子邮件复制方法 | `sales_email/magento_rma_customer_comment/copy_method` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
管理员中提供了这些配置值，位置如下： **商店** >设置> **配置** > **销售** > **税金**.

| 名称 | 配置路径 | 仅限商务？ |
|--------------|--------------|--------------|
| 装运的税分类 | `tax/classes/shipping_tax_class` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 赠品选项的税分类 | `tax/classes/wrapping_tax_class` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| 基于以下项的计税方法： | `tax/calculation/algorithm` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 应用税于 | `tax/calculation/apply_tax_on` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 显示运费 | `tax/display/shipping` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 显示运费金额 | `tax/cart_display/shipping` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 显示礼品包装价格 | `tax/cart_display/gift_wrapping` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 显示打印卡价格 | `tax/cart_display/printed_card` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 按订单总计包括税金 | `tax/cart_display/grandtotal` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 显示运费金额 | `tax/sales_display/shipping` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 显示礼品包装价格 | `tax/sales_display/gift_wrapping` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 显示打印卡价格 | `tax/sales_display/printed_card` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 按订单总计包括税金 | `tax/sales_display/grandtotal` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 在“产品视图”页面上显示价格 | `tax/weee/display` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 名称 | 配置路径 | 仅限商务？ |
|--------------|--------------|--------------|
| 启用Onepage结帐 | `checkout/options/onepage_checkout_enabled` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 预览报价生命周期（分钟） | `checkout/cart/preview_quota_lifetime` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| 名称 | 配置路径 | 仅限商务？ |
|--------------|--------------|--------------|
| 应用自定义配送策略 | `shipping/shipping_policy/enable_shipping_policy` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
管理员中提供了这些配置值，位置如下： **商店** >设置> **配置** > **销售** > **多配送设置**.

| 名称 | 配置路径 | 仅限商务？ |
|--------------|--------------|--------------|
| 允许配送至多个地址 | `multishipping/options/checkout_multiple` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用RMA | `carriers/ups/active_rma` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| 装运来源 | `carriers/ups/origin_shipment` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 启用议定费率 | `carriers/ups/negotiated_active` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 最大包装重量（请咨询您的货运公司，了解支持的最大装运重量） | `carriers/ups/max_package_weight` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 取车方式 | `carriers/ups/pickup` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 最小包装重量（请咨询您的货运公司，了解所支持的最小运输重量） | `carriers/ups/min_package_weight` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用RMA | `carriers/usps/active_rma` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| 最大包装重量（请咨询您的货运公司，了解支持的最大装运重量） | `carriers/usps/max_package_weight` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用RMA | `carriers/fedex/active_rma` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| 丢帧 | `carriers/fedex/dropoff` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 重量单位 | `carriers/fedex/unit_of_measure` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 最大包装重量（请咨询您的货运公司，了解支持的最大装运重量） | `carriers/fedex/max_package_weight` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用RMA | `carriers/dhl/active_rma` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
| 就绪时间 | `carriers/dhl/ready_time` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 帐户类型 | `google/analytics/type` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 启用内容实验 | `google/analytics/experiments` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 目录页面的列表属性 | `google/analytics/catalog_page_list_value` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 交叉销售块的列表属性 | `google/analytics/crosssell_block_list_value` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 向上销售块的列表属性 | `google/analytics/upsell_block_list_value` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 相关产品块的列表属性 | `google/analytics/related_block_list_value` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 搜索结果页面的列表属性 | `google/analytics/search_page_list_value` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
| 促销活动字段“标签”的“内部促销活动”。 | `google/analytics/promotions_list_value` | ![Commerce-only](/help/assets/configuration/cloud-ee.png) |
...
管理员中提供了这些配置值，位置如下： **商店** >设置> **配置** > **销售** > **礼品卡**.
...
| 在订单项目为时生成礼品卡帐户 | `giftcard/general/order_item_status` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 每隔X个字符划出虚线 | `giftcard/giftcardaccount_general/code_split` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
