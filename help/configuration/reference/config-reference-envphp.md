...
| `x-frame-options` | [x-frame-options](../security/xframe-options.md)的设置 |
...
了解有关[可下载域](/help/tools/reference/commerce-on-premises.md#downloadabledomainsadd)的更多信息。
...
了解有关[消息队列](https://developer.adobe.com/commerce/php/development/components/message-queues/)的详细信息。
