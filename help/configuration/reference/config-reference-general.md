...
本主题列出了常规和高级配置路径以及 _not_ [敏感值和系统特定值](config-reference-sens.md). 的 [`magento app:config:dump` 命令](../cli/export-configuration.md) 将这些值写入共享配置文件， `app/etc/config.php`，它应位于源代码管理中。
...
这些配置值在的“管理员”中可用 **商店** >设置> **配置** >常规> **常规**.
...
| 邮政编码是 | `general/country/optional_zip_countries` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> | ![敏感](/help/assets/configuration/cloud-sens.png) |
| 欧盟国家 | `general/country/eu_countries` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> | ![敏感](/help/assets/configuration/cloud-sens.png) |
| 热门目标 | `general/country/destinations` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 状态是 | `general/region/state_required` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 如果国家/地区为可选状态，则允许选择“州” | `general/region/display_all` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |  |
...
| 权重单位 | `general/locale/weight_unit` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |  |
| 每周的第一天 | `general/locale/firstday` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |  |
| 周末日 | `general/locale/weekend` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |  |
| 访问限制 | `general/restriction/is_active` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |  |
| 限制模式 | `general/restriction/mode` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |  |
| “启动”页 | `general/restriction/http_redirect` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |  |
| 登陆页面 | `general/restriction/cms_page` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |  |
| HTTP响应 | `general/restriction/http_status` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |  |
| 存储名称 | `general/store_information/name` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |  |
| 存储电话号码 | `general/store_information/phone` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |  |
| 存储操作小时数 | `general/store_information/hours` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |  |
...
| 街道地址2号线 | `general/store_information/street_line2` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |  |
...
| CMS“无Cookie”页 | `web/default/cms_no_cookies` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 如果禁用了Cookie，则重定向到CMS页面 | `web/browser_capabilities/cookies` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 如果JavaScript处于禁用状态，则显示通知 | `web/browser_capabilities/javascript` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 如果本地存储被禁用，则显示通知 | `web/browser_capabilities/local_storage` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 名称 | 配置路径 | 仅限商业？ |
|--------------|--------------|--------------|
| 基本货币 | `currency/options/base` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 向发送电子邮件 | `contact/email/recipient_email` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
这些配置值在的“管理员”中可用 **商店** >设置> **配置** > **常规** > **报表**.
...
这些配置值在的“管理员”中可用 **商店** >设置> **配置** > **常规** > **内容管理**.

| 名称 | 配置路径 | 仅限商业？ |
|--------------|--------------|--------------|
| 启用WYSIWYG编辑器 | `cms/wysiwyg/enabled` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 在WYSIWYG for Catalog中为媒体内容使用静态URL | `cms/wysiwyg/use_static_urls_in_catalog` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 名称 | 配置路径 | 仅限商业？ |
|--------------|--------------|--------------|
| 启用新的Relic集成 | `newrelicreporting/general/enable` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 新旧版应用程序名称 | `newrelicreporting/general/app_name` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| “启动”页 | `admin/startup/menu_item_id` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 最大密码重置请求数 | `admin/security/max_number_password_reset_requests` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 向URL添加密钥 | `admin/security/use_form_key` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 登录区分大小写 | `admin/security/use_case_sensitive_login` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 管理员会话生命周期（秒） | `admin/security/session_lifetime` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 锁定帐户的最大登录失败数 | `admin/security/lockout_failures` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 在管理员中启用CAPTCHA | `admin/captcha/enable` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 尝试登录失败的次数 | `admin/captcha/failed_attempts_login` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 已启用的操作 | `admin/magento_logging/actions` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 在以下情况下重试正在进行的消息 | `system/mysqlmq/retry_inprogress_after` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 生成每个计划 | `system/cron/index/schedule_generate_every` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 提前计划 | `system/cron/index/schedule_ahead_for` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 未在内运行时缺失 | `system/cron/index/schedule_lifetime` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 历史清理 | `system/cron/index/history_cleanup_every` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 成功历史存留期 | `system/cron/index/history_success_lifetime` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 失败历史记录生命周期 | `system/cron/index/history_failure_lifetime` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 使用单独的流程 | `system/cron/index/use_separate_process` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 生成每个计划 | `system/cron/default/schedule_generate_every` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 提前计划 | `system/cron/default/schedule_ahead_for` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 未在内运行时缺失 | `system/cron/default/schedule_lifetime` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 历史清理 | `system/cron/default/history_cleanup_every` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 成功历史存留期 | `system/cron/default/history_success_lifetime` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 失败历史记录生命周期 | `system/cron/default/history_failure_lifetime` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 生成每个计划 | `system/cron/staging/schedule_generate_every` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |
| 提前计划 | `system/cron/staging/schedule_ahead_for` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |
| 未在内运行时缺失 | `system/cron/staging/schedule_lifetime` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |
| 历史清理 | `system/cron/staging/history_cleanup_every` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |
| 成功历史存留期 | `system/cron/staging/history_success_lifetime` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |
| 失败历史记录生命周期 | `system/cron/staging/history_failure_lifetime` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |
| 使用单独的流程 | `system/cron/staging/use_separate_process` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |
| 生成每个计划 | `system/cron/catalog/event/schedule_generate_every` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |
| 提前计划 | `system/cron/catalog/event/schedule_ahead_for` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |
| 未在内运行时缺失 | `system/cron/catalog/event/schedule_lifetime` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |
| 历史清理 | `system/cron/catalog/event/history_cleanup_every` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |
| 成功历史存留期 | `system/cron/catalog/event/history_success_lifetime` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |
| 失败历史记录生命周期 | `system/cron/catalog/event/history_failure_lifetime` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |
| 使用单独的流程 | `system/cron/catalog/event/use_separate_process` | ![仅限商务](/help/assets/configuration/cloud-ee.png) |
| 使用单独的流程 | `system/cron/default/use_separate_process` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 回访路径电子邮件 | `system/smtp/return_path_email` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 更新频度 | `system/adminnotification/frequency` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 上次更新 | `system/adminnotification/last_update` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 启用定时备份 | `system/backup/enabled` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 日志归档频率 | `system/rotation/frequency` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 选择媒体数据库 | `system/media_storage_configuration/media_database` （在Commerce 2.4.3中弃用） | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 为Storefront启用模板路径提示 | `dev/debug/template_hints_storefront` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 日志到文件 | `dev/debug/debug_logging` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 日志到syslog | `dev/syslog/syslog_logging` |  |
| 为Storefront启用 | `dev/translate_inline/active` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 对静态文件进行签名 | `dev/static/sign` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
