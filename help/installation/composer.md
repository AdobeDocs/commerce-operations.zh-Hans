...
我们使用 [编辑器](https://getcomposer.org/) 管理Adobe Commerce和Magento Open Source组件及其依赖项。 使用编辑器获取Adobe Commerce和Magento Open Source [元包](https://glossary.magento.com/metapackage) 具有以下优势：
