...
Adobe Commerce支持nginx 1.x（或[最新的主行版本](https://nginx.org/en/linux_packages.html#mainline)）。 您还必须安装最新版本的`php-fpm`。
...
您还可以从源[构建nginx](https://www.armanism.com/blog/install-nginx-on-ubuntu)
...
1. 安装`php-fpm`和`php-cli`：
   ...
   >[!NOTE]
   >
   >此命令安装最新可用版本的PHP 7.2.X。有关支持的PHP版本，请参阅[系统要求](../../system-requirements.md)。
