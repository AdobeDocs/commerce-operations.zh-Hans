...
有关云配置指南，请参阅[云基础架构上的Commerce](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/configure/app/php-settings)指南中的&#x200B;_PHP设置_。
...
- 未正确安装[PHP mcrypt扩展](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/php-mcrypt-extension-not-installed-properly)
...
- [常见PHP错误和解决方案](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/common-php-fatal-errors-and-solutions)
