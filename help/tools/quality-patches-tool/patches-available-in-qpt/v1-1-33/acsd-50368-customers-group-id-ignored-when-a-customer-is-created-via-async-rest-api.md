...
>[!NOTE]
>
>已部分弃用ACSD-50368修补程序，因为对于2.4.4以上的版本，强制安全修补程序[APSB25-08](https://experienceleague.adobe.com/zh-hans/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/security-update-available-for-adobe-commerce-apsb25-08)已解决此问题。

ACSD-50368修补程序修复了在通过异步REST API或异步批量REST API创建客户时忽略客户group_id的问题。 安装[[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/zh-hans/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.33时，此修补程序可用。 修补程序ID为ACSD-50368。 请注意，该问题计划在Adobe Commerce 2.4.7中修复。
