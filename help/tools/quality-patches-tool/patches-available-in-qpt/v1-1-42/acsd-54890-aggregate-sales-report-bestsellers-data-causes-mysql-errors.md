...
ACSD-54890修补程序修复了`aggregate_sales_report_bestsellers_data`由于`/tmpdisk`空间不足而导致[!DNL MySQL]错误的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.42时，此修补程序可用。 修补程序ID为ACSD-54890。 请注意，该问题计划在Adobe Commerce 2.4.7中修复。
...
* [在Commerce实施行动手册中修改数据库表的最佳实践](/help/implementation-playbook/best-practices/development/modifying-core-and-third-party-tables.md#why-adobe-recommends-avoiding-modifications)
