...
ACSD-54626修补程序修复了客户无法通过GraphQL创建具有`createPurchaseOrderApprovalRule`属性的新采购订单规则(`NUMBER_OF_SKUS`)的问题。 安装[!DNL Quality Patches Tool (QPT)] 1.1.42时，此修补程序可用。 修补程序ID为ACSD-54626。 请注意，该问题计划在Adobe Commerce 2.4.7中修复。
...
客户无法通过GraphQL创建具有`createPurchaseOrderApprovalRule`属性的新采购订单规则(`NUMBER_OF_SKUS`)。
