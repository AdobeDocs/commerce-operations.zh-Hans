...
ACSD-55628修补程序修复了在公司注册表中上传文件以及在店面中替换客户属性文件的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.42时，此修补程序可用。 修补程序ID为ACSD-55628。 请注意，该问题计划在Adobe Commerce 2.4.7中修复。
