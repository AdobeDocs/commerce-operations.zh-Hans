...
ACSD-54972修补程序修复了在更改类别URL后，规范类别URL未更新的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.43时，此修补程序可用。 修补程序ID为ACSD-54972。 请注意，该问题计划在Adobe Commerce 2.4.7中修复。
