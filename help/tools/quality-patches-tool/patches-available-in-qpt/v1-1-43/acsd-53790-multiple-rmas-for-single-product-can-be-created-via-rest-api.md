...
ACSD-53790修补程序修复了通过&#x200B;*Rest API*&#x200B;为单个产品创建多个RMA的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.43时，此修补程序可用。 修补程序ID为ACSD-53790。 请注意，该问题计划在Adobe Commerce 2.4.7中修复。
