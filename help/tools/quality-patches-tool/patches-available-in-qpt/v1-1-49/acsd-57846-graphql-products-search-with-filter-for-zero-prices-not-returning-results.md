...
ACSD-57846修补程序修复了以下问题：按零价格筛选产品会导致向[!DNL OpenSearch]发出格式错误的请求，并且不会返回任何结果。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.49时，此修补程序可用。 修补程序ID为ACSD-57846。 请注意，Adobe Commerce 2.4.7中已修复此问题。
