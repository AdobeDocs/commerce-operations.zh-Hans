...
>[!NOTE]
>
>对于版本2.4.6-p7到2.4.6-p10，修补程序ACSD-49392被替换为修补程序[ACSD-57003](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-46/acsd-57003-order-status-changed-to-complete-instead-of-processing.md)。
