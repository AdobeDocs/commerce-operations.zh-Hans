...
ACSD-57394修补程序修复了在[!DNL GraphQL]中使用多个排序属性时产品排序不正确的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.48时，此修补程序可用。 修补程序ID为ACSD-57394。 请注意，该问题计划在Adobe Commerce 2.5.0中修复。
