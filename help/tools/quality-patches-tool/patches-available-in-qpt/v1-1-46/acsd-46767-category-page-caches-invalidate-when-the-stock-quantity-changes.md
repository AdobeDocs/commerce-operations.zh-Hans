...
ACSD-46767修补程序修复了库存数量更改时[!UICONTROL Category]页面缓存失效的问题，即使产品仍然有库存。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.46时，此修补程序可用。 修补程序ID为ACSD-46767。 请注意，该问题计划在Adobe Commerce 2.4.6中修复。
