...
ACSD-47107修补程序修复了将目录价格规则应用于自定义选项的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.23时，此修补程序可用。 修补程序ID为ACSD-47107。 请注意，该问题计划在Adobe Commerce 2.4.6中修复。
