...
ACSD-47803修补程序修复了缺货的可配置产品样本显示为可用的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.24时，此修补程序可用。 修补程序ID为ACSD-47803。 请注意，该问题计划在Adobe Commerce 2.4.6中修复。
