...
MDVA-26005修补程序解决了用户在类别树中无法为购物车价格规则条件选择类别的问题。 安装[Quality Patches Tool (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.4时，此修补程序可用。 修补程序ID为MDVA-26005。 请注意，Adobe Commerce 2.3.6中已修复此问题。
