...
description: MDVA-40961修补程序修复了当购物车中已有最小项目数量时，无法将其他项目添加到购物车的问题。 安装[Quality Patches Tool (QPT)](https://experienceleague.adobe.com/zh-hans/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.15后，即可使用此修补程序。 修补程序ID为MDVA-40961。 请注意，该问题计划在Adobe Commerce 2.4.5中修复。
...
MDVA-40961修补程序修复了当购物车中已有最小项目数量时，无法将其他项目添加到购物车的问题。 安装[Quality Patches Tool (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.15后，即可使用此修补程序。 修补程序ID为MDVA-40961。 请注意，该问题计划在Adobe Commerce 2.4.5中修复。
