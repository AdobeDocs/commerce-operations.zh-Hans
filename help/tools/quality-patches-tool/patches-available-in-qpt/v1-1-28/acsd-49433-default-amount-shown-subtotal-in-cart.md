...
ACSD-49433修补程序修复了在购物车中显示未结金额礼品卡默认金额的小计的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.28时，此修补程序可用。 修补程序ID为ACSD-49433。 请注意，该问题计划在Adobe Commerce 2.4.7中修复。
