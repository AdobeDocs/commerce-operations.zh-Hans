...
description: MDVA-42950修补程序解决了视频未在产品页面上播放的问题。 安装[Quality Patches Tool (QPT)](https://experienceleague.adobe.com/zh-hans/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches) 1.1.12后，即可使用此修补程序。 修补程序ID为MDVA-42950。 请注意，该问题计划在Adobe Commerce 2.4.5中修复。
feature: Products
role: Admin
...
MDVA-42950修补程序解决了视频未在产品页面上播放的问题。 安装[Quality Patches Tool (QPT)](https://experienceleague.adobe.com/zh-hans/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches) 1.1.12后，即可使用此修补程序。 修补程序ID为MDVA-42950。 请注意，该问题计划在Adobe Commerce 2.4.5中修复。
