...
ACSD-45169修补程序修复了在应用暂存更新后，可视化促销程序无法显示可配置产品的正确库存和价格的问题。 安装[Quality Patches Tool (QPT)](https://experienceleague.adobe.com/zh-hans/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches) 1.1.17时，此修补程序可用。 修补程序ID为ACSD-45169。 请注意，该问题计划在Adobe Commerce 2.4.6中修复。
