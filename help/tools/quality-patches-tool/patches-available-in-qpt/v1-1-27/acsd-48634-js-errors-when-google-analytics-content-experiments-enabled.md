...
启用[!DNL Google Analytics Content Experiments]后，ACSD-48634修补程序修复了[!DNL staging]更新页面上的[!DNL JS]错误。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.27时，此修补程序可用。 修补程序ID为ACSD-48634。 请注意，Adobe Commerce 2.4.7中已修复此问题。
