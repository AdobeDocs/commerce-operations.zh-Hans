...
1. **ACSD-61622**：修复了响应中缺少[!DNL FedEx]帐户特定费率的问题。 ACSD-61622取代了从 [!DNL SOAP] 迁移到 [!DNL RESTful API]](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27131)的[[!DNL FedEx] 送货方法集成中记录的修复。
