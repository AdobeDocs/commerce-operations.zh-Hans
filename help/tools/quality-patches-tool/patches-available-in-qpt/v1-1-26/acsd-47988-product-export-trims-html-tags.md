...
ACSD-47988修补程序修复了产品导出会从页面生成器产品描述中去除HTML标记的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.26时，此修补程序可用。 修补程序ID为ACSD-47988。 请注意，该问题计划在Adobe Commerce 2.4.7中修复。
