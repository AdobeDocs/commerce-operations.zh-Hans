...
MDVA-44940修补程序修复了从管理员保存类别时发生SQL错误的问题。 安装[Quality Patches Tool (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.16后，即可使用此修补程序。 修补程序ID为MDVA-44940。 请注意，该问题计划在Adobe Commerce 2.4.6中修复。
