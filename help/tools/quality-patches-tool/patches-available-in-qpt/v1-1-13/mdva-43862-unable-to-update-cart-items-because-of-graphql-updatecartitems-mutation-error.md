...
MDVA-43862修补程序解决了由于GraphQL UpdateCartItems突变错误而导致客户无法更新购物车项目的问题。 安装[Quality Patches Tool (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.13后，即可使用此修补程序。 修补程序ID为MDVA-43862。 请注意，该问题计划在Adobe Commerce 2.4.5中修复。
