...
ACSD-49129修补程序修复了&#x200B;*产品媒体API响应中未返回* content *[!UICONTROL base64 image code]*&#x200B;属性(`rest/V1/products/sku/media`)的问题。 安装[!DNL Quality Patches Tool (QPT)] 1.1.30时，此修补程序可用。 修补程序ID为ACSD-49129。 请注意，该问题计划在Adobe Commerce 2.4.7中修复。
...
*产品媒体API响应中未返回* content *[!UICONTROL base64 image code]*&#x200B;属性(`rest/V1/products/sku/media`)。
