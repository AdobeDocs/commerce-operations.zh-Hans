...
MDVA-42237修补程序修复了可配置产品的特殊价格在子产品价格发生更改后未更新的问题。 安装[Quality Patches Tool (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.11时，此修补程序可用。 修补程序ID为MDVA-42237。 请注意，该问题计划在Adobe Commerce 2.4.5中修复。
