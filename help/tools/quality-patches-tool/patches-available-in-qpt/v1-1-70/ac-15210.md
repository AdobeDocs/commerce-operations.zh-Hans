...
应用修补程序后，更新Commerce USPS运输运营商配置以与新的USPS API集成。 有关说明，请参阅&#x200B;*存储和购买体验指南*&#x200B;中的[USPS Web工具弃用](https://experienceleague.adobe.com/zh-hans/docs/commerce-admin/stores-sales/delivery/shipping-carriers/carriers#usps-web-tools-api-deprecation)主题。
