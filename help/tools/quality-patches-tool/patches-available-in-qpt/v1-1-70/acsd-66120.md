...
1. 转到&#x200B;**[!UICONTROL Stores]** > **[!UICONTROL Tax Zones and Rates]** > **[!UICONTROL Add new Tax Rate]**。
   ...
   1. 在&#x200B;**[!UICONTROL Rate Percent]**&#x200B;字段中输入&#x200B;*20.000000*。
   1. 单击&#x200B;**[!UICONTROL Save]**。
...
1. 转到&#x200B;**[!UICONTROL Catalog]** > **[!UICONTROL Products]** > **[!UICONTROL Add Product]**。
   1. 在&#x200B;**[!UICONTROL Product Name]**&#x200B;字段中输入&#x200B;*test*。
   1. 在&#x200B;**[!UICONTROL SKU]**&#x200B;字段中输入&#x200B;*test*。
   1. 在&#x200B;**[!UICONTROL Price]**&#x200B;字段中输入&#x200B;**82.65**。
   1. 将&#x200B;**[!UICONTROL Tax Class]**&#x200B;设置为&#x200B;*应纳税商品*。
   1. 在&#x200B;**[!UICONTROL Quantity]**&#x200B;字段中输入&#x200B;*100*。
   1. 单击&#x200B;**[!UICONTROL Save]**。
1. 将范围更改为&#x200B;*默认存储视图*。
...
1. 转到&#x200B;**[!UICONTROL Marketing]** > *[!UICONTROL Promotions]* > **[!UICONTROL Catalog Price Rule]** > **[!UICONTROL Add New Rule]**。
   ...
   1. 在&#x200B;**[!UICONTROL Discount Amount]**&#x200B;字段中输入&#x200B;*20.000000*。
   1. 单击&#x200B;**[!UICONTROL Save]**。
1. 执行完全重新索引：
...
1. 使用标头中设置的&#x200B;**[!UICONTROL Store]**&#x200B;执行以下[!DNL GraphQL]查询： *default*：
