...
1. 从&#x200B;**[!UICONTROL Cart Price Rules]** > **[!UICONTROL Admin]** > **[!UICONTROL Marketing]**&#x200B;创建&#x200B;**[!UICONTROL Promotion]**&#x200B;并在下订单时添加任何匹配的条件（示例：小计大于&#x200B;*5$*）
...
正确的计数应显示在管理员中&#x200B;**的**&#x200B;已用时间&#x200B;**和**&#x200B;已用&#x200B;**列中，其中**&#x200B;的&#x200B;**[!UICONTROL manage coupon]**&#x200B;是&#x200B;**[!UICONTROL cart price rule]**&#x200B;值。
