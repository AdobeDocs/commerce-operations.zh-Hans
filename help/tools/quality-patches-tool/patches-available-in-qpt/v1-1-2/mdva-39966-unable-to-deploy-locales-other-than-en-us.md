...
description: MDVA-39966修补程序解决了用户无法部署en_US以外的区域设置的问题。 安装[Quality Patches Tool (QPT)](https://experienceleague.adobe.com/zh-hans/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches) 1.1.2后，即可使用此修补程序。 修补程序ID为MDVA-39966。 请注意，Adobe Commerce版本2.4.1中已修复此问题。
feature: Deploy
role: Admin
...
MDVA-39966修补程序解决了用户无法部署en_US以外的区域设置的问题。 安装[Quality Patches Tool (QPT)](https://experienceleague.adobe.com/zh-hans/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches) 1.1.2后，即可使用此修补程序。 修补程序ID为MDVA-39966。 请注意，Adobe Commerce版本2.4.1中已修复此问题。
