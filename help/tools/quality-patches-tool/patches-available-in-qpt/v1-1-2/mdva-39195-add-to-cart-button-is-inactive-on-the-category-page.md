...
MDVA-39195修补程序解决了启用重定向到购物车后，“类别”页面上的&#x200B;**添加到购物车**&#x200B;按钮处于非活动状态的问题。 安装[Quality Patches Tool (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.2后，即可使用此修补程序。 修补程序ID为MDVA-39195。 请注意，Adobe Commerce 2.4.3中已修复此问题。
