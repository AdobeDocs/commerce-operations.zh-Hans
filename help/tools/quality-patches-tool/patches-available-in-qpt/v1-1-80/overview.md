...
1. **[ACP2E-4493](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4493.md)**：修复了在启用异步索引时，销售订单存档网格显示错误订单状态的问题。
1. **[ACP2E-4239](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4239.md)**：修复了由于所选日期、存储的[!DNL UTC]值和配置的存储区时区之间的时区不匹配，使用日期属性的管理网格筛选器未返回任何结果的问题。
1. **[ACP2E-4481](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4481.md)**：修复了订单取消后捆绑产品可销售性重新计算不正确的问题。
...
1. **[ACP2E-4610](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4610.md)**：修复了`sales_clean_quotes` cron作业存在性能问题的问题。
1. **[ACP2E-4552](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4552.md)**：修复了GraphQL响应中未返回公司状态的问题。
...
1. **[ACP2E-4615](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4615.md)**：修复了在线订单退款失败并出现PayPal错误（显示&#x200B;*PayPal网关拒绝请求）的问题。 内部错误。*。
...
1. **[ACP2E-4813](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4813.md)**：修复了以下问题：在结账时无法使用USPS配送方式，并且某些产品的配送估计不正确，包括拆分为多个套件的订单。
...
1. **[ACSD-53502](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acsd-53502.md)**：修复了以下问题：由于递归调用New Relic监视脚本，导致&#x200B;**[!UICONTROL Add to Cart]**&#x200B;在iOS [!DNL Safari]中的店面间歇性地失败，进而导致页面重新加载。
