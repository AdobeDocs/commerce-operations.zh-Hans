...
ACSD-67187修补程序修复了管理员用户被限制访问非默认网站时出现错误&#x200B;*的问题。请至少创建一个公共共享目录以继续*，并且无法访问&#x200B;**[!UICONTROL Company]**&#x200B;网格上的&#x200B;**[!UICONTROL Add New Company]**&#x200B;按钮。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.72时，此修补程序可用。 修补程序ID为ACSD-67187。 请注意，此问题计划在Adobe Commerce B2B 1.5.3中修复。
...
限制到非默认网站的管理员用户看到错误&#x200B;*请至少创建一个公共共享目录以继续*，并且无法访问&#x200B;**[!UICONTROL Company]**&#x200B;网格上的&#x200B;**[!UICONTROL Add New Company]**&#x200B;按钮。
...
错误&#x200B;*请至少创建一个公共共享目录以继续。* 显示在&#x200B;**[!UICONTROL Companies]**&#x200B;网格上。
