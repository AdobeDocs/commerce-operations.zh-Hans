...
ACSD-60631修补程序修复了将同一产品分配给多个可配置产品时，GraphQL查询返回错误的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.51时，此修补程序可用。 修补程序ID为ACSD-60631。 请注意，此问题计划在Adobe Commerce 2.4.8中修复。
