...
ACSD-59786修补程序修复了GraphQL查询在获取过期报价的`quote_id`时返回错误的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.51时，此修补程序可用。 修补程序ID为ACSD-59786。 请注意，该问题计划在Adobe Commerce 2.4.8中修复。
