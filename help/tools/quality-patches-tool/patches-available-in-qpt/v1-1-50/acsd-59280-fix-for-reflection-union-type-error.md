...
ACSD-59280修补程序修复了在安装2.4.4-pX版本期间出现`call to undefined method ReflectionUnionType::getName()`错误的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.50时，此修补程序可用。 修补程序ID为ACSD-59280。 请注意，Adobe Commerce 2.4.5中已修复此问题。
