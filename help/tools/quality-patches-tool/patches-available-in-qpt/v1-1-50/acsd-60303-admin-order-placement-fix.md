...
description: 应用ACSD-60303修补程序以修复以下问题：如果启用了Adobe Commerce缩小，则无法提交管理员的订单。
feature: Orders
...
ACSD-60303修补程序修复了启用HTML缩小功能后无法向管理员下达订单的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.50时，此修补程序可用。 修补程序ID为ACSD-60303。 请注意，此问题计划在2.4.8中修复。
