...
ACSD-46213修补程序修复了类别树请求仅限于20个类别的问题。 安装[Quality Patches Tool (QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.19后，即可使用此修补程序。 修补程序ID为ACSD-46213。
