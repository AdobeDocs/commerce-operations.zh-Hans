...
description: 应用ACSD-51666修补程序以修复错误*会话已过期，请重新登录。*在尝试登录后发生Adobe Commerce问题。
feature: Customers
...
ACSD-51666修补程序修复了错误&#x200B;*会话已过期的问题，请重新登录。* 在您尝试登录后发生。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.36时，此修补程序可用。 修补程序ID为ACSD-51666。 请注意，该问题计划在Adobe Commerce 2.4.7中修复。
...
您收到错误&#x200B;*会话已过期，请重新登录。* 在重置另一台设备上的密码后，尝试使用新密码从一台设备登录时。 仅当自定义模块添加的页面上有其他Ajax请求时，才会发生这种情况。
