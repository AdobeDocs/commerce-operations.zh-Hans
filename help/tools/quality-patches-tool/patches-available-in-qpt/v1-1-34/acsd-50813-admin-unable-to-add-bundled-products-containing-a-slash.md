...
ACSD-50813修补程序修复了以下问题：管理员无法在具有`/`功能的SKU中将包含斜杠(*[!UICONTROL Add Products by SKU]*)的捆绑产品添加到管理员订单中。 安装[!DNL Quality Patches Tool (QPT)] 1.1.34时，此修补程序可用。 修补程序ID为ACSD-50813。 请注意，该问题计划在Adobe Commerce 2.4.7中修复。
...
管理员无法在具有`/`功能的SKU中将包含斜杠(*[!UICONTROL Add Products by SKU]*)的捆绑产品添加到管理员订单中。
