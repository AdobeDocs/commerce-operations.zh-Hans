...
ACSD-52277修补程序修复了在Admin中创建新订单时，选择商店视图后，管理员用户未正确重定向的问题。 安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.34时，此修补程序可用。 修补程序ID为ACSD-52277。 请注意，Adobe Commerce 2.4.7中已修复此问题。
