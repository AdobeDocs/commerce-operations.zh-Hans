...
ACSD-64523修补程序修复了REST端点[V1/import/csv]无法验证必填字段的问题，从而允许在没有必需数据的情况下创建产品。 要解决此问题，请更新授权标头。安装[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.62时，此修补程序可用。 请注意，该问题计划在Adobe Commerce 2.4.8中修复。
