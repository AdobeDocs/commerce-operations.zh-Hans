...
1. 按照[!DNL RabbitMQ]先决条件[[!DNL RabbitMQ] 中的说明配置](https://experienceleague.adobe.com/zh-hans/docs/commerce-operations/installation-guide/prerequisites/message-brokers/rabbitmq)。
