...
1. 按照[[!DNL RabbitMQ] 先决条件](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/prerequisites/message-brokers/rabbitmq)中的说明配置[!DNL RabbitMQ]。
