...
**[!UICONTROL Patches]**： [!UICONTROL Patches]页面显示[[!DNL Quality Patches Tool]中的所有当前修补程序：搜索与商家的Adobe Commerce实例版本兼容的修补程序](https://experienceleague.adobe.com/tools/commerce-quality-patches/index.html){target="_blank"}。 在“工具”指南中了解有关[[!DNL Quality Patches Tool]：高质量修补程序自助服务工具](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md)的更多信息。
