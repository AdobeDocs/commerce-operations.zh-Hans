...
我们已在Magento Open Source2.4.8核心代码中修复了231个问题。 此版本中包含的已修复问题的子集如下所述。
...
* _AC-11673_：
   ...
   * _GitHub代码贡献_：确保最新版本的php-amqplib/php-amqplib最新版本应该兼容
...
* _AC-12022_：
   ...
   * _GitHub代码贡献_：系统已更新为使用“monolog/monolog”库的最新主要版本，从而确保兼容性和改进性能。 以前，系统使用的是“monolog/monolog”库的过时版本，这可能导致潜在的问题和限制。
* _AC-12023_：
...
* _AC-12024_：
   ...
   * _GitHub问题_： &lt;<https://github.com/magento/magento2/commit/de4dfb8e>>
   * _GitHub代码贡献_：将jquery/validate库依赖关系升级到最新的次要版本
* _AC-12025_：
   * _修复注释_：将moment.js系统依赖关系升级到最新的次要版本
   * _GitHub问题_： &lt;<https://github.com/magento/magento2/commit/de4dfb8e>>
   * _GitHub代码贡献_：将moment.js系统依赖关系升级到最新的次要版本
* _AC-12267_：
   * _修复注释_：支持Redis会话的连接重试并与colimollenhour/php-redis-session-abstract v2.0.0兼容
   * _GitHub问题_： &lt;<https://github.com/magento/magento2/commit/672a2e61>>
   * _GitHub代码贡献_：确保最新版本的colimollenhour/php-redis-session-abstract v2.0.0与adobe commerce兼容
...
* _AC-8714_：
   * _修复注释_：涂漆7.3 — 默认类别的子类别链接/选项未显示在店面主页上
   * _GitHub问题_： &lt;<https://github.com/magento/magento2/commit/d1c335aa>，&lt;https://github.com/magento/magento2/ （内部，未合并）>>
   * _GitHub代码贡献_： Storefront主页现在按预期显示默认类别子类别。 以前，购物者只能通过URL访问子类别。
...
* _AC-9712_： https://github.com/magento/magento2/issues/37841
   ...
   * _GitHub问题_： &lt;&lt;https://github.com/magento/magento2/ （内部，未合并）>>
   * _GitHub代码贡献_：修复php &amp; nodejs库(grunt)之间较少编译的差异
...
* _AC-12128_：
   * _修复注释_：[Cloud] Prototype.js安全漏洞CVE-2020-27511
   * _GitHub问题_： &lt;<https://github.com/magento/magento2/commit/de4dfb8e>>
   * _GitHub代码贡献_：应解决安全漏洞CVE-2020-27511
...
* _AC-12950_：在composer.json中更新tinymce 7.3.0并从tinymce 7的文件中删除
   * _修复说明_：将TinyMCE 7.x设置为Adobe Commerce 2.4.8-beta1支持的版本
   * _GitHub代码贡献_： &lt;https://github.com/magento/magento2/ （内部，未合并）>
