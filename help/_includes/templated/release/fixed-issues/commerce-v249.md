...
我们已在Adobe Commerce 2.4.9核心代码中修复了666个问题。 此版本中包含的已修复问题的子集如下所述。
...
_AC-12321 - [GitHub问题](https://github.com/magento/magento2/issues/38827) - [GitHub代码贡献](https://github.com/magento/magento2/pull/38864)_
...
_AC-1608 - [GitHub问题](https://github.com/magento/magento2/issues/34342) - [GitHub代码贡献](https://github.com/magento/magento2/pull/34897)_
...
_ACP2E-4621 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c12a7510)_
...
_AC-16227 - [GitHub问题](https://github.com/magento/magento2/issues/40361) - [GitHub代码贡献](https://github.com/magento/magento2/pull/40416)_

#### 网站和商店对象会将ID作为字符串返回

修复了网站和商店ID作为字符串而非整数返回的问题。 这解决了严格模式下的类型错误，从而允许EmailNotification：：newAccount()和类似方法正常工作。

_AC-16486 - [GitHub问题](https://github.com/magento/magento2/issues/40469)_

#### 客户城市验证不适用于不允许的字符

修复了客户地址可能使用无效字符（如/、@、#、！）保存的问题 在城市田野里。 进行此修复后，系统会正确验证并拒绝包含不允许字符的地址。

_AC-16504 - [GitHub问题](https://github.com/magento/magento2/issues/40521) - [GitHub代码贡献](https://github.com/magento/magento2/commit/57bad413)_
...
_AC-16659 - [GitHub问题](https://github.com/magento/magento2/issues/40570) - [GitHub代码贡献](https://github.com/magento/magento2/pull/40563)_
...
_ACP2E-4527 - [GitHub代码贡献](https://github.com/magento/magento2/commit/f2fd9628)_

#### 地址验证器在升级到2.4.8-p3后中断现有客户

以前，在本修复之前，使用字符的现代电话号码。 或\未正确验证。 应用此修复后，带有字符的现代电话号码。 或\现已验证。

_ACP2E-4554 - [GitHub代码贡献](https://github.com/magento/magento2/commit/aa2e16d1)_
...
_ACP2E-4524 - [GitHub代码贡献](https://github.com/magento/magento2/commit/aa2e16d1)_
...
_AC-16378 - [GitHub问题](https://github.com/magento/magento2/issues/40468) - [GitHub代码贡献](https://github.com/magento/magento2/pull/40225)_

#### 对于相同的配置，购物车页面和产品页面中的FPT值不同

修复了由于四舍五入不一致，产品页面和购物车页面上的固定产品税(FPT)值显示不同的问题。 进行此修复后，目录、产品和购物车页面中的FPT价格现在是一致的，从而消除了不匹配的情况。

_AC-16550 - [GitHub代码贡献](https://github.com/magento/magento2/commit/8391dbcc)_
...
浮动颜色现在按预期应用于管理员静态网格的行。[GitHub-35358](https://github.com/magento/magento2/issues/35358)
...
_ACP2E-4447 - [GitHub代码贡献](https://github.com/magento/magento2/commit/e2b23caa)_

#### 启用异步网格索引时，存档网格未与最新订单数据同步

销售订单存档网格现在显示具有异步索引的正确订单状态

_ACP2E-4493 - [GitHub代码贡献](https://github.com/magento/magento2/commit/f2fd9628)_

#### 产品属性批量更新更改产品类型虚拟 — >简单

防止“这是否具有权重？” 在插入批量更新属性面板之前激活控件，从而避免虚拟产品的意外权重更改。

_ACP2E-4500 - [GitHub代码贡献](https://github.com/magento/magento2/commit/e2b23caa)_
...
_ACP2E-4630 - [GitHub代码贡献](https://github.com/magento/magento2/commit/d8a248cd)_
...
_ACP2E-4675 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c58a8ad0) - [GitHub代码贡献](https://github.com/magento/magento2-page-builder/commit/5fd20dbb)_
...
_ACP2E-4605 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c12a7510)_
...
_ACP2E-4724 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c58a8ad0)_
...
_ACP2E-4615 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c58a8ad0)_
...
_ACP2E-4488 - [GitHub代码贡献](https://github.com/magento/magento2/commit/f2fd9628)_
...
_ACP2E-4626 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c12a7510)_
...
_AC-16639 - [GitHub问题](https://github.com/magento/magento2/issues/40590) - [GitHub代码贡献](https://github.com/magento/magento2/pull/40463)_
...
_ACP2E-4363 - [GitHub代码贡献](https://github.com/magento/magento2/commit/e2b23caa)_

#### 由于analytics_collect_data cron执行，[云]性能下降

提高与Analytics cron作业相关的性能。

_ACP2E-4496 - [GitHub代码贡献](https://github.com/magento/magento2/commit/f2fd9628)_
...
_ACP2E-4608 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c12a7510)_
...
_AC-14460 - [GitHub代码贡献](https://github.com/magento/magento2/commit/57bad413)_
...
_AC-15963 - [GitHub问题](https://github.com/magento/magento2/issues/40255) - [GitHub代码贡献](https://github.com/magento/magento2/pull/40248)_
...
_AC-16417 - [GitHub问题](https://github.com/magento/magento2/issues/40503) - [GitHub代码贡献](https://github.com/magento/magento2/commit/8391dbcc)_
...
_ACP2E-4472 - [GitHub代码贡献](https://github.com/magento/magento2/commit/e2b23caa)_

#### 捆绑产品行为与统一费率配送和免运费不一致

在修复之前，在通过购物车折扣规则提供捆绑产品时，未正确计算捆绑产品的免费发运。 修复后，将正确计算捆绑产品的免费送货次数。

_ACP2E-4536 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c12a7510)_

#### 无法为具有数字SKU的产品下订单

订购具有数字SKU的产品时，系统不再引发错误。

_ACP2E-4669 - [GitHub代码贡献](https://github.com/magento/inventory/commit/83d11138)_

#### 客户地址属性(EAV)验证规则与硬编码验证规则冲突。

改进了客户地址电话验证功能，可支持最多255个字符的值，使服务器端检查与数据库限制保持一致。 错误处理也进行了改进，使超长的电话号码返回明确的长度特定消息。

_ACP2E-4735 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c58a8ad0)_
...
_ACP2E-4491 - [GitHub代码贡献](https://github.com/magento/magento2/commit/e2b23caa)_
...
_ACP2E-4673 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c58a8ad0)_
...
_AC-14541 - [GitHub问题](https://github.com/magento/magento2/issues/39863) - [GitHub代码贡献](https://github.com/magento/magento2/pull/40421)_
...
_AC-14626 - [GitHub问题](https://github.com/magento/magento2/issues/35670) - [GitHub代码贡献](https://github.com/magento/magento2/pull/40412)_
...
_AC-14897 - [GitHub问题](https://github.com/magento/magento2/issues/39964)_
...
_AC-15044 - [GitHub问题](https://github.com/magento/magento2/issues/40027) - [GitHub代码贡献](https://github.com/magento/magento2/pull/40431)_
...
_AC-15746 - [GitHub问题](https://github.com/magento/magento2/issues/40205) - [GitHub代码贡献](https://github.com/magento/magento2/pull/40203)_
...
_AC-16380 - [GitHub问题](https://github.com/magento/inventory/issues/3384) - [GitHub代码贡献](https://github.com/magento/inventory/pull/3385) - [GitHub代码贡献](https://github.com/magento/inventory/commit/b4aeda50)_
...
_AC-16437 - [GitHub代码贡献](https://github.com/magento/magento2/commit/57bad413)_
...
修复后，与`--skip_hidden_images`标志一起使用的`catalog:images:resize`命令将不会为没有图像的网站生成图像缓存。
...
_ACP2E-4505 - [GitHub代码贡献](https://github.com/magento/magento2/commit/f2fd9628)_
...
_ACP2E-4533 - [GitHub代码贡献](https://github.com/magento/magento2/commit/aa2e16d1)_
...
_ACP2E-4529 - [GitHub代码贡献](https://github.com/magento/magento2/commit/f2fd9628)_
...
#### [小错误]当字段值包含`\`时，无法点击管理面板`listing component`的筛选器
...
_AC-16544 - [GitHub问题](https://github.com/magento/magento2/issues/40536)_

#### 保存“目录事件列表程序”CMS块时，显示“CMS块包含无效内容”错误

修复了保存默认的“目录事件列表程序”CMS块时显示错误“CMS块包含无效内容”的问题。 进行此修复后，块可成功保存，且不会在“管理”面板中出现任何错误。

_AC-16686 - [GitHub代码贡献](https://github.com/magento/magento2/commit/0c9a749b)_
...
_AC-14940 - [GitHub代码贡献](https://github.com/magento/magento2/commit/3e41a43b)_
...
_AC-15945 - [GitHub问题](https://github.com/magento/magento2/issues/40243)_

#### [问题]阻止包含`comment=""`的`db_schema.xml`声明破坏零停机部署
...
#### [问题]从`Magento_Downloadable`中删除禁止的`@author`标记
...
#### [问题]从`Magento_Backup`和`Magento_Bundle`中删除禁止的`@author`标记
...
_ACP2E-4512 - [GitHub代码贡献](https://github.com/magento/magento2/commit/e2b23caa)_
...
_ACP2E-4585 - [GitHub代码贡献](https://github.com/magento/magento2/commit/aa2e16d1)_
...
_ACP2E-4762 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c58a8ad0)_
...
_ACP2E-4587 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c12a7510)_
...
_ACP2E-4481 - [GitHub代码贡献](https://github.com/magento/inventory/commit/96b77663)_

#### 当多个客户同时下订单时，Magento允许过度销售

有了MSI，多个客户可以同时订购同一产品，并超出可用库存，导致超额销售。 修复后，如果同时运行结账，则每个产品只能有一个订单能够成功，因此不再发生过度销售。

_ACP2E-4509 - [GitHub代码贡献](https://github.com/magento/inventory/commit/a33c60f2)_

#### 如果客户在购物篮中有超过140篇文章，则[CLOUD]超时

清单数据库查询已得到优化，可在签出期间快速加载清单数据。 这消除了对每个SKU进行单独查询的需求，从而显着提高了大型购物车的结账性能。

_ACP2E-4519 - [GitHub代码贡献](https://github.com/magento/inventory/commit/40858072)_
...
_ACP2E-4403 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c12a7510)_
...
_AC-14848 - [GitHub问题](https://github.com/magento/magento2/issues/39884) - [GitHub代码贡献](https://github.com/magento/magento2/pull/40428)_
...
_AC-16256 - [GitHub问题](https://github.com/magento/magento2/issues/40403) - [GitHub代码贡献](https://github.com/magento/magento2/commit/3e41a43b)_
...
_AC-16680 - [GitHub代码贡献](https://github.com/magento/inventory/commit/d3b2ef0b)_
...
_ACP2E-4455 - [GitHub代码贡献](https://github.com/magento/magento2/commit/e2b23caa)_
...
_ACP2E-4601 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c12a7510)_
...
_ACP2E-4610 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c58a8ad0)_

#### 上一层子类别在管理类别树中显示零产品计数

在修复之前，叶类别在管理员区域类别树中显示时没有合并产品计数。 修复后，将正确显示每个类别叶的产品计数。

_ACP2E-4689 - [GitHub代码贡献](https://github.com/magento/magento2/commit/d8a248cd)_
...
_ACP2E-4475 - [GitHub代码贡献](https://github.com/magento/magento2/commit/f2fd9628) - [GitHub代码贡献](https://github.com/magento/inventory/commit/a33c60f2)_
...
_AC-15494 - [GitHub问题](https://github.com/magento/magento2/issues/40178) - [GitHub代码贡献](https://github.com/magento/magento2/pull/40423)_
...
_ACP2E-4653 - [GitHub代码贡献](https://github.com/magento/magento2/commit/d8a248cd)_

#### 免费配送的购物车价格规则无法按预期用于捆绑产品

改进免运费处理

_ACP2E-4720 - [GitHub代码贡献](https://github.com/magento/magento2/commit/c58a8ad0)_
...
_AC-16626 - [GitHub问题](https://github.com/magento/magento2/issues/40580) - [GitHub代码贡献](https://github.com/magento/magento2/pull/40581)_
...
_AC-16577 - [GitHub问题](https://github.com/magento/magento2/issues/40394) - [GitHub代码贡献](https://github.com/magento/magento2/commit/15a9362d)_
...
_ACP2E-4556 - [GitHub代码贡献](https://github.com/magento/magento2/commit/aa2e16d1)_
...
_AC-16530 - [GitHub代码贡献](https://github.com/magento/magento2/commit/57bad413)_
...
_ACP2E-4433 - [GitHub代码贡献](https://github.com/magento/magento2/commit/f2fd9628)_
...
_ACP2E-4411 - [GitHub代码贡献](https://github.com/magento/magento2/commit/aa2e16d1)_
...
_AC-16018 - [GitHub问题](https://github.com/magento/magento2/issues/40253) - [GitHub代码贡献](https://github.com/magento/magento2/pull/40239)_
...
#### [问题]从`Magento_Backend`中删除禁止的`@author`标记
