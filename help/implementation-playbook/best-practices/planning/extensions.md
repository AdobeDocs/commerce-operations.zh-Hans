...
- 在云基础架构上将第三方扩展与Adobe Commerce结合使用
   ...
   - [为何要在集成和暂存环境中完全进行测试？](https://experienceleague.adobe.com/en/docs/commerce-cloud-service/user-guide/launch/overview#why-test-fully-in-integration-staging-and-production)
