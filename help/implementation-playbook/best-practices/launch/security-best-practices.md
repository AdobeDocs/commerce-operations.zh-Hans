...
>[!NOTE]
>
>有关在云基础架构上保护和维护Adobe Commerce项目的角色和责任的信息，请参阅[Adobe Commerce安全和合规性指南](https://experienceleague.adobe.com/zh-hans/docs/commerce-operations/security-and-compliance/shared-responsibility#security-responsibilities-chart)中的&#x200B;_共享责任模型_。
