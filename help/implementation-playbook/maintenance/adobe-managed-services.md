...
Adobe Managed Services与内部部署和非托管云实施相比具有关键优势，包括：
...
有关主要Managed Services优势的更详细比较，请查看下表：
...
![显示Adobe Managed Services安全栈栈的图表](../../assets/playbooks/managed-services-security-stack.svg)
