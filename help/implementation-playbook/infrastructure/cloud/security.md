...
请参阅&#x200B;_云指南_&#x200B;中的[Fastly服务概述](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/cdn/fastly.html)。
...
>[!NOTE]
>
>本页概述了有关GDPR的考虑事项。 有关Adobe Commerce如何存储个人信息的详细信息，请参阅&#x200B;_[安全和合规性指南](../../../security-and-compliance/privacy/gdpr.md)_。 要确定您的企业应如何遵守任何法律义务，请咨询您的法律顾问或参阅[正式文本](https://eur-lex.europa.eu/eli/reg/2016/679/oj)。

## 备份

在过去24小时的操作中，每小时执行一次备份。 在24小时之后，将使用AWS EBS快照服务按计划保留备份。 请参阅&#x200B;_云指南_&#x200B;中的[保留策略](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/architecture/pro-architecture.html#retention-policy)。
...
请参阅&#x200B;_云指南_&#x200B;中的[快照和备份管理](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/develop/storage/snapshots.html)。
